...
{
    public partial class NewReq_changesMass : System.Web.UI.Page
    {
        public string MHid;
            ...
            try
            {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                        ...
                        string FN = "EMET_NewReqMass";
                        string PL = Session["EPlant"].ToString();
                        if (EMETModule.IsAuthor(UI, FN, PL) == false)
                        {
                            Response.Redirect("QQPreview.aspx?Number=" + Request.QueryString["Number"]);
                        }
                        else
                        {
                    ...
                    {
                        //ScriptManager.RegisterStartupScript(UpdatePanel1, UpdatePanel1.GetType(), "CallMyFunction", "freezeheader();", true);
        ...
        protected void Countryoforigin(string Quno)
        {
            ...
            try
            {
                ...
                str = "select TQ.CountryOrg, TC.CountryDescription from " + TransDB.ToString() + @"TQuoteDetails_d TQ INNER 
                JOIN TCountrycode TC ON TC.CountryCode=TQ.CountryOrg WHERE QuoteNo = @Quno ";
                Result = new DataTable();
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
        ...
        protected void GetDataVendRate(string ProcGroup, string MachineId)
        {
            ...
            try
            {
                ...
                {
                    cmd = new SqlCommand(str, MDMCon);
                    cmd.Parameters.AddWithValue("@VendorCode", Session["VendorCode"].ToString());
                    cmd.Parameters.AddWithValue("@Plant", strplant);
        ...
        private void GetQuoteandAllDetails(string QuoteNo)
        {
            ...
            try
            {
                ...
                if (dtdate.Rows.Count > 0)
                {
                    ...
                    Session["VPlant"] = dtdate.Rows[0]["Plant"].ToString();
                    string plant = dtdate.Rows[0].ItemArray[3].ToString();
                    string Product = dtdate.Rows[0].ItemArray[8].ToString();
        ...
        protected void showDataQuoreReqRevice(string newQN, string OldQN)
        {
            ...
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    sql = @" select QuoteNo,TQ.CountryOrg,TQ.CommentByVendor,
        ...
        private void GetQuoteupdated(string QuoteNo)
        {
            ...
            try
            {
                ...
                {
                    Label14.Text = ": " + "Waiting for Submission";
                }
        ...
        protected void GetData(string reqno)
        {
            ...
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    cmd.Parameters.AddWithValue("@VendorCode1", Session["VendorCode"].ToString());
                    sda.SelectCommand = cmd;
                    sda.Fill(dtget);
                }
        ...
        protected void btnaddProcessCost_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CreateDynamicProcessDT(PCAddCount);
                System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "ProcessCostDataStore();freezeheader();", true);
                //CreateDynamicProcessDT(0);
                //PCAddCount++;
                //CreateDynamicProcessDT(PCAddCount);
            }
        ...
        bool SendMail()
        {
            ...
            try
            {
                //Email
                //testing sending new
                #region ggetting Messageheader ID from IT Mailapp
        ...
        private void RetrieveAllCostDetails()
        {
            ...
            try
            {
                ...
                strsub = @"SELECT QuoteNo,ProcessGroup,UPPER([Sub-Mat/T&JDescription]) as 'Sub-Mat/T&JDescription',[Sub-Mat/T&JCost] as 'Sub-Mat/T&JCost',[Consumption(pcs)] as 'Consumption(pcs)',
                            [Sub-Mat/T&JCost/pcs] as 'Sub-Mat/T&JCost/pcs',CAST(ROUND([TotalSub-Mat/T&JCost/pcs],5) AS DECIMAL(12,5)) as 'TotalSub-Mat/T&JCost/pcs',RowId 
                            from TSMCCostDetails Where  QuoteNo = @QuoteNo order by RowId asc";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                ...
                strProcess = "SELECT PCD.[QuoteNo],PCD.[ProcessGroup],PCD.[ProcessGrpCode],PCD.[SubProcess],PCD.[IfTurnkey-VendorName]," +
                             ...
                             "PCD.[TurnKeyCost],PCD.[TurnKeyProfit],PCD.[ProcessCost/pc],[TotalProcessesCost/pcs],5) AS DECIMAL(12,5)) as [TotalProcessesCost/pcs],PCD.[RowId]," +
                ...
                strUnitData = @"select TotalMaterialCost,TotalProcessCost,TotalSubMaterialCost,TotalOtheritemsCost,GrandTotalCost,Profit,Discount,FinalQuotePrice,CommentByVendor 
        ...
        private void RetrieveCostDetailsMassRevMatCostOnly()
        {
            SqlConnection EmetCon = new SqlConnection(EMETModule.GenEMETConnString());
            ...
            try
            {
                ...
                {
                    cmd = new SqlCommand(strMCIM, EmetCon);
                    cmd.Parameters.AddWithValue("@QuoteNo", hdnQuoteNoRefmassRev.Value);
                    sda.SelectCommand = cmd;
                    sda.Fill(dtget);
                }
        ...
        private void RetrieveCostDetailsMassRev()
        {
            SqlConnection EmetCon = new SqlConnection(EMETModule.GenEMETConnString());
            ...
            try
            {
                ...
                strGetData = @"SELECT QuoteNo,ProcessGroup,UPPER(ItemsDescription) as 'ItemsDescription',[OtherItemCost/pcs] as 'OtherItemCost/pcs'
                            ,CAST(ROUND([TotalOtherItemCost/pcs],5) AS DECIMAL(12,5)) as 'TotalOtherItemCost/pcs',RowId 
                            FROM TOtherCostDetails Where  QuoteNo = @QuoteNo order by RowId asc ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    cmd = new SqlCommand(strGetData, EmetCon);
                    cmd.Parameters.AddWithValue("@QuoteNo", hdnQuoteNoRefmassRev.Value);
                ...
                strProcess = "SELECT PCD.[QuoteNo],PCD.[ProcessGroup],PCD.[ProcessGrpCode],PCD.[SubProcess],PCD.[IfTurnkey-VendorName]," +
                             ...
                             "PCD.[Machine/Labor],PCD.[Machine],CAST(ROUND(PCD.[StandardRate/HR],7) AS DECIMAL(12,2))as 'StandardRate/HR',CAST(ROUND(PCD.VendorRate,7) AS DECIMAL(12,2))as 'VendorRate'," +
                             "PCD.[ProcessUOM],PCD.[Baseqty],PCD.[DurationperProcessUOM(Sec)],PCD.[Efficiency/ProcessYield(%)]," +
                             "PCD.[TurnKeyCost],PCD.[TurnKeyProfit],PCD.[ProcessCost/pc],CAST(ROUND([TotalProcessesCost/pcs],5) AS DECIMAL(12,5)) as [TotalProcessesCost/pcs],PCD.[RowId]," +
                             "PCD.[UpdatedBy],PCD.[UpdatedOn] FROM  " + TransDB.ToString() + "[TProcessCostDetails] PCD  Where PCD.[QuoteNo] = @QuoteNo order by RowId asc ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    cmd = new SqlCommand(strProcess, EmetCon);
        ...
        private void MCCostDataStore()
        {
            try
            {
                ...
                {
                    string PostBacFromUpload = "0";
                    if (Session["PostBacFromUpload"] != null)
                    {
                        PostBacFromUpload = Session["PostBacFromUpload"].ToString();
                    }

                    if (PostBacFromUpload == "1")
                    {
                        if (ccc > 1)
                        {
                            CreateDynamicDT(ccc);
