...
namespace Material_Evaluation
{
    ...
    public partial class PIRGeneration : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["userID"] == null || Session["EPlant"]== null)
                {
        ...
        protected void GetDbTrans()
        {
            try
            {
                TransDBName = EMETModule.GetDbTransname();
            }
            catch (Exception ex)
            {
                LbMsgErr.Text = ex.StackTrace.ToString() + " - " + ex.Message.ToString(); DvMsgErr.Visible = true;
        ...
        protected void Quotedetailsload(string processgrp)
        {
            ...
            try
            {
                ...
                string str = @"select tq.Plant,tq.Requestnumber,tq.Quoteno,tq.vendorcode1,tq.vendorname, tq.Material,tq.MaterialDesc,
                               ...
                               where tq.ManagerApprovalStatus='" + 2 + "' and (isMassRevision=0 or isMassRevision is null)";
                if (txtFind.Text != "")
                {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (concatenated != "") {
                    ...
                    SqlDataAdapter da = new SqlDataAdapter();
                    //    string str = "select VendorCode,VendorName from TVENDOR_PROCESSGROUP where ProcessGrp='" + ddlprocess.SelectedItem.Text + "'";
                    string str = @"select vendor,material,purchasorg,plant,inforcatstd,jobtyp,countryorg,CoNumber,ordunit,denominate,numerator,
                                plndeliver,purgrp,stdqty,minqty,grbaseiv,cfmctlkey,taxcode,netprice,currency,priuntval,ordpriunit,pridatectl,
                                validon,validto,condition1,amt1,unit1,per1,uom1,condition2,amt2,unit2,per2,uom2,condition3,amt3,unit3,per3,uom3,
                                condition4,amt4,unit4,per4,uom4,infornote,infotext1,infotext2,infotext3,infotext4,infotext5,potext,potext1,potext2,potext3,
                                potext4,potext5,Quotation,Quotation_Due,Underdelivery_Tolerance_Percentage,Overdelivery_Tolerance_Percentage,Supply_availability_from,Supply_availability_to,
                                Vendor_subrange,Prod_version from " + TransDB.ToString() + "tpir_report where quotation in(" + concatenated.ToString() + ")";
                    da = new SqlDataAdapter(str, EmetCon);
                    Result = new DataTable();
                    da.Fill(Result);
                ...
                if (LsQuoteNo.Count > 0)
                {
                    ...
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        string sql = @" select A.Material,replace((A.MaterialDesc + space(60-len(A.MaterialDesc))),' ','&nbsp;') as MaterialDesc,A.QuoteNo,A.VendorName,
                                    ...
                                    (select case when len(US.UseNam) > 13 then CONCAT(left(US.UseNam,13),'...') else UseNam end as UseNam from " + DbMasterName + @".dbo.Usr US where US.UseID = A.AprRejBy) as Dname,
                                    ...
                                    and (A.CreateStatus <> '' or A.CreateStatus is not null)  
                                    and (A.ApprovalStatus = 3 and A.ManagerApprovalStatus = 2 and A.DIRApprovalStatus = 0)  
                                    and (A.isUseSAPCode = 1) and (A.isMassRevision <> 1)  
                                     ";
                        string SortBy = "";
                ...
                string str = @"
                        <p style='font-size: 8px; padding-top:15px;'>
                                        <table border='1'>
                                            <thead>
                                                <tr> 
                                                    <th  border='0' style='text-align:left' colspan='14'> <h5><strong>e-MET PIR Generation</strong> </h5> <br /> </td>
                                                </tr>
                                                <tr>
        ...
        //                                    <thead>
        //                                        <tr> 
        //                                            <th  border='0' style='text-align:left' colspan='14'> <h5><strong>e-MET PIR Generation</strong> </h5> </td>
        //                                        </tr>
        //                                        <tr>
        ...
        //                                        <tr>
        //                                            <th border='1' style='text-align:center'><b>Material</b></th>
        //                                            <th border='1' style='text-align:center; width:800px'><b>Material Desc</b></th>
        //                                            <th border='1' style='text-align:center'><b>Quote No</b></th>
        //                                            <th border='1' style='text-align:center'><b>Vendor Name</b></th>
        ...
        //                    str += @"</tr>";
        //                }
        //                str += @"<tr border='0' style='text-align:right'> <td  border='0' style='text-align:right' colspan='14'> Download from e-MET PIR Generation on " + CurrDate + "  </td> </tr>";
        //            }
        //        }
        //        str += @"                   </tbody>
        //                                </table>
        ...
        //                Response.AddHeader("content-disposition", "attachment;filename=eMET Approve.pdf");
