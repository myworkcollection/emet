<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EAllRequest.aspx.cs" Inherits="Material_Evaluation.EAllRequest" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            mainUrl = window.location.href.replace("EAllRequest.aspx", "");
            SetUpSideBar();
            DatePitcker();
            GenerateTableReport();
        });
