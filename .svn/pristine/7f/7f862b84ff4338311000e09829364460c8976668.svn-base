...
{
    public partial class EWhitoutSAPCodeGp : System.Web.UI.Page
    {
        string sql;
        SqlCommand cmd;
        ...
        protected void ShowTable()
        {
            ...
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    {
                        sql += @" ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='5' and Plant  = '" + Session["EPlant"].ToString() + @"' ) ";
                    }
                    else if (DdlStatus.SelectedIndex == 2)
                    {
                        sql += @" ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='4' and Plant  = '" + Session["EPlant"].ToString() + @"' ) ";
                    }
                    else if (DdlStatus.SelectedIndex == 3)
                    {
                        sql += @" ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='6' and Plant  = '" + Session["EPlant"].ToString() + @"' ) ";
                    }
                    else
                    {
                        sql += @" ( ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='4' and Plant  = '" + Session["EPlant"].ToString() + @"' ) or
                                    ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='5' and Plant  = '" + Session["EPlant"].ToString() + @"' ) or
                                    ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='6' and Plant  = '" + Session["EPlant"].ToString() + @"' ) ) ";
                    }
        ...
        protected void ShowTableDet(string RequestNumber, int RowParentGv)
        {
            ...
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    if (DdlStatus.SelectedIndex == 1)
                    {
                        sql += @" ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='5' and Plant  = '" + Session["EPlant"].ToString() + @"' and RequestNumber = '" + RequestNumber + @"' ) ";
                    }
                    else if (DdlStatus.SelectedIndex == 2)
                    {
                        sql += @" ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='4' and Plant  = '" + Session["EPlant"].ToString() + @"' and RequestNumber = '" + RequestNumber + @"' ) ";
                    }
                    else if (DdlStatus.SelectedIndex == 3)
                    {
                        sql += @" ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='6' and Plant  = '" + Session["EPlant"].ToString() + @"' and RequestNumber = '" + RequestNumber + @"' ) ";
                    }
                    else
                    {
                        sql += @" ( ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='4' and Plant  = '" + Session["EPlant"].ToString() + @"' and RequestNumber = '" + RequestNumber + @"' ) or
                                    ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='5' and Plant  = '" + Session["EPlant"].ToString() + @"' and RequestNumber = '" + RequestNumber + @"' ) or
                                    ( (SELECT RIGHT(QuoteNo, 2)) = 'GP' and ApprovalStatus='6' and Plant  = '" + Session["EPlant"].ToString() + @"' and RequestNumber = '" + RequestNumber + @"' ) ) ";
                    }
        ...
        protected void isAuthor()
        {
            ...
            string sql;
            SqlDataReader reader;
            string FormName = "EWhitoutSAPCodeGP";
            string System = "EMET";
            try
            {
                MDMCon.Open();
