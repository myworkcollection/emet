<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Announcement.aspx.cs" Inherits="Material_Evaluation.Announcement" %>
                              ...
                              <div class="row">
                                   <div  class="col-xl-3 col-sm-6 mb-3">
                                    ...
                                    <a class="card-footer text-white clearfix small z-1" href="#">
                                      <span style="width:100%" class="float-left">05/12/18<br />
                                            SPL is having Half yearly presentation on 1th Dec and there will be visitors from other Team Shimano Plants and our Car park may have fewer parking lots.
                                            <br /> Visitors are advised to clear the Car park as soon as possible. 
                                            <br />07/12/18<br />
                                            Please note that SPL is conducting Annual Inventory on 29th Dec18 till 31Dec18. No delivery during this period.
                                       </span>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Pinnsoft 2018</span>
            </div>
          </div>
        </footer>
