    ...
    public partial class VViewRequest : System.Web.UI.Page
    {
        ...
        private void RetrieveAllCostDetails()
        {
            ...
            try
            {
                ...
                if (hdnQuoteNoRefmassRev.Value == "")
                {
                    strMCIM += @" Where  TMC.QuoteNo = N'" + hdnQuoteNo.Value.ToString() + "' order by RowId asc  ";
                }
                else
                {
                    if (QuoteStatus == "")
                    {
                        strMCIM += @" Where  TMC.QuoteNo = N'" + hdnQuoteNoRefmassRev.Value.ToString() + "' order by RowId asc  ";
                    }
                    else
                    {
                        strMCIM += @" Where  TMC.QuoteNo = N'" + hdnQuoteNo.Value.ToString() + "' order by RowId asc  ";
