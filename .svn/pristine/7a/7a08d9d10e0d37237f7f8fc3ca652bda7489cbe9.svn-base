<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VViewRequestMassRev.aspx.cs" Inherits="Material_Evaluation.VViewRequestMassRev" %>
                    ...
                    if (Layout == "Layout1") {
                        if (rowscountTabBOM <= 1) {
                            for (var i = 1; i < rowscountTabMatCost; i++) {
                                ...
                                if (FieldName == "Raw Material SAP Code" || FieldName == "Raw Material Description" || FieldName == "Raw Material Cost/ kg" || FieldName == "Part Net Unit Weight (g)"
                                    ...
                                    if (tr != null) {
                                        for (var z = 1; z < CellsCountTabMatCost; z++) {
                                            if (FieldName == "Part Net Unit Weight (g)") {
                                                ...
                                                if (FieldName == "Raw Material SAP Code" || FieldName == "Raw Material Description" || FieldName == "Raw Material Cost/ kg") {
                                ...
                                <div class="row" style="padding-bottom: 10px;">
                                    <div class="col-md-6 text-left">
                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:Button ID="BtnSubmit" runat="server" Text="Approve" CssClass="btn btn-success" OnClientClick="ShowLoading();" OnClick="BtnSubmit_Click" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
