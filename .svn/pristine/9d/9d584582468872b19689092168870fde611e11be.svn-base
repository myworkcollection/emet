<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReqWaitVndMass.aspx.cs" Inherits="Material_Evaluation.ReqWaitVndMass" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:Panel runat="server" DefaultButton="btnSearch">
                                        <div class="row">
                                            <div class="col-lg-4" style="padding-bottom: 5px;">
                                                <asp:DropDownList runat="server" ID="DdltaskStatus" ToolTip="Task Status">
                                                    ...
                                                    <asp:ListItem Text="Waiting For SMN Submission" Value="MassRevision"></asp:ListItem>
                                                    <asp:ListItem Text="Waiting For Confirmation" Value="MassRevision-Draft"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        ...
                                        <div class="row" runat="server" id="DvFilterDiffrence" visible="true">
                                            <div class="col-lg-4" style="padding-bottom: 5px;">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <asp:Label runat="server" ID="Label3" Text="Diffrence"></asp:Label>
                                                    </div>
                                                    <div class="col-md-4 ">
