    ...
    public partial class Review_reqMass : System.Web.UI.Page
    {
        ...
        protected void Countryoforigin()
        {
            ...
            try
            {
                ...
                str = "select TQ.CountryOrg, TC.CountryDescription from " + TransDB.ToString() + @"TQuoteDetails_d TQ 
                    INNER JOIN TCountrycode TC ON TC.CountryCode=TQ.CountryOrg WHERE QuoteNo = @QuoteNo";
                Result = new DataTable();
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
        ...
        private void RetrieveAllCostDetails()
        {
            ...
            try
            {
                ...
                strGetData = "SELECT * FROM TOtherCostDetails_D Where  QuoteNo = @QuoteNo order by RowId asc ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                ...
                string strsub = "";
                dtget = new DataTable();
                strsub = "SELECT * FROM TSMCCostDetails_D Where  QuoteNo = @QuoteNo order by RowId asc ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                ...
                strProcess = "SELECT PCD.[QuoteNo],PCD.[ProcessGroup],PCD.[ProcessGrpCode],PCD.[SubProcess],PCD.[IfTurnkey-VendorName]," +
                             ...
                             "PCD.[UpdatedBy],PCD.[UpdatedOn] FROM  " + TransDB.ToString() + "[TProcessCostDetails_D] PCD  Where PCD.[QuoteNo] = @QuoteNo order by RowId asc ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
