<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Material_Evaluation.Approval" EnableEventValidation="false" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function ApprOrRejectCondition(id) {
            try {
                ...
                if (GridViewName == "GvDecision") {
                    ...
                    var RbRejReverseToDraft = $("#GvDecision_RbRejReverseToDraft_" + id + "");
                    ...
                    else if (RbRejReverseToDraft != null && RbRejReverseToDraft.prop("checked")) {
                        if (RbRejReverseToDraft.prop("checked")) {
                            if (GvDecision_ChckChangeDate_ == true) {
                                alert('Cannot Resubmit when Change date is Checked');
                    ...
                    var RbRejReverseToDraft = $("#GvDecCompr_RbRejReverseToDraft_" + id + "");
        ...
        function ApprOrRejectConditionAfterSubmit(id) {
            try {
                var GridViewName = $("#TxtGvName").val();
                if (GridViewName == "GvDecision") {
                    var GvDecision_ChckChangeDate_ = $("#GvDecision_ChckChangeDate_" + id + "").prop("checked");
                    ...
                    if ($("#GvDecision_RbApprove_" + id + "").prop("checked")) {
                        ...
                        if (GvDecision_ChckChangeDate_ == true) {
                            ...
                            $("#GvDecision_TxtreasonApproval_" + id + "").hide();
                            $("#GvDecision_LblengtVC_" + id + "").hide();
                            var ddlId = document.getElementById("GvDecision_DdlReject_" + id);
                            var DdlValue = ddlId.options[ddlId.selectedIndex].value;
                            if (DdlValue == "Others") {
                                $("#GvDecision_TxtRejOth_" + id + "").show();
                                $("#GvDecision_LblengtVCRej_" + id + "").show();
                            }
                            else {
                                $("#GvDecision_TxtRejOth_" + id + "").hide();
                                $("#GvDecision_LblengtVCRej_" + id + "").hide();
                    ...
                    if ($("#GvDecCompr_RbApprove_" + id + "").prop("checked")) {
                        ...
                        if (GvDecCompr_ChckChangeDate_ == true) {
                            ...
                            $("#GvDecCompr_TxtreasonApproval_" + id + "").hide();
                            $("#GvDecCompr_LblengtVC_" + id + "").hide();
                            var ddlId = document.getElementById("GvDecCompr_DdlReject_" + id);
                            var DdlValue = ddlId.options[ddlId.selectedIndex].value;
                            if (DdlValue == "Others") {
                                $("#GvDecCompr_TxtRejOth_" + id + "").show();
                                $("#GvDecCompr_LblengtVCRej_" + id + "").show();
                            }
                            else {
                                $("#GvDecCompr_TxtRejOth_" + id + "").hide();
                                $("#GvDecCompr_LblengtVCRej_" + id + "").hide();
        ...
        function reverseGridviewLastCondition() {
            try {
                var GridView = document.getElementById('GvDecision');
                if (GridView.rows.length > 0) {
                    for (var i = 1; i < GridView.rows.length; i++) {
                        ChckDateChange(i - 1);
                        ApprOrRejectConditionAfterSubmit(i - 1);
                    }
                }
            } catch (e) {
                alert("reverseGridviewLastCondition : " + e)
            }
        }

        function ChckDateChange(id) {
            try {

                var GridViewName = $("#TxtGvName").val();
                if (GridViewName == "GvDecision") {
                    var GvDecision_RbApprove_ = $("#GvDecision_RbApprove_" + id + "").prop("checked");
                    var GvDecision_RbReject_ = $("#GvDecision_RbReject_" + id + "").prop("checked");

                    if ($("#GvDecision_ChckChangeDate_" + id + "").prop("checked")) {
                        if ((GvDecision_RbApprove_ == false && GvDecision_RbApprove_ == false) || (GvDecision_RbApprove_ == false)) {
                            alert('Change date Only for Action Approve !');
                            $("#GvDecision_ChckChangeDate_" + id + "").prop('checked', false);
                            $("#GvDecision_TxtNewEffDate_" + id + "").css("backgroundColor", "#EBEBE4");
                            $("#GvDecision_TxtNewDueDate_" + id + "").css("backgroundColor", "#EBEBE4");
                        }
                        else {
                            $("#GvDecision_TxtNewEffDate_" + id + "").attr('disabled', false);
                            $("#GvDecision_TxtNewDueDate_" + id + "").attr('disabled', false);
                            $("#GvDecision_TxtNewEffDate_" + id + "").css("backgroundColor", "white");
                            $("#GvDecision_TxtNewDueDate_" + id + "").css("backgroundColor", "white");
                            DatePitckerAppr(id);
                        }
                    }
                    else {
                        $("#GvDecision_TxtNewEffDate_" + id + "").attr('disabled', true);
                        $("#GvDecision_TxtNewDueDate_" + id + "").attr('disabled', true);
                        $("#GvDecision_TxtNewEffDate_" + id + "").css("backgroundColor", "#EBEBE4");
                        $("#GvDecision_TxtNewDueDate_" + id + "").css("backgroundColor", "#EBEBE4");

                        var table = document.getElementById('GvDecision');
                        var IsSBM = $("#TxtIsSBM").val();
                        var EffDate = "";
                        var DueDate = "";
                        if (IsSBM.toString() == "1") {
                            EffDate = table.rows[(id + 1)].cells[11].innerHTML;
                            DueDate = table.rows[(id + 1)].cells[12].innerHTML;
                        }
                        else {
                            EffDate = table.rows[(id + 1)].cells[12].innerHTML;
                            DueDate = table.rows[(id + 1)].cells[13].innerHTML;
                        }
                        $("#GvDecision_TxtNewEffDate_" + id + "").val(EffDate);
                        $("#GvDecision_TxtNewDueDate_" + id + "").val(DueDate);
                    }
                }
                else {
                    var GvDecCompr_RbApprove_ = $("#GvDecCompr_RbApprove_" + id + "").prop("checked");
                    var GvDecCompr_RbReject_ = $("#GvDecCompr_RbReject_" + id + "").prop("checked");

                    if ($("#GvDecCompr_ChckChangeDate_" + id + "").prop("checked")) {
                        if ((GvDecCompr_RbApprove_ == false && GvDecCompr_RbApprove_ == false) || (GvDecCompr_RbApprove_ == false)) {
                            alert('Change date Only for Action Approve !');
                            $("#GvDecCompr_ChckChangeDate_" + id + "").prop('checked', false);
                            $("#GvDecCompr_TxtNewEffDate_" + id + "").css("backgroundColor", "#EBEBE4");
                            $("#GvDecCompr_TxtNewDueDate_" + id + "").css("backgroundColor", "#EBEBE4");
                        }
                        else {
                            $("#GvDecCompr_TxtNewEffDate_" + id + "").attr('disabled', false);
                            $("#GvDecCompr_TxtNewDueDate_" + id + "").attr('disabled', false);
                            $("#GvDecCompr_TxtNewEffDate_" + id + "").css("backgroundColor", "white");
                            $("#GvDecCompr_TxtNewDueDate_" + id + "").css("backgroundColor", "white");
                            DatePitckerAppr(id);
                        }
                    }
                    else {
                        $("#GvDecCompr_TxtNewEffDate_" + id + "").attr('disabled', true);
                        $("#GvDecCompr_TxtNewDueDate_" + id + "").attr('disabled', true);
                        $("#GvDecCompr_TxtNewEffDate_" + id + "").css("backgroundColor", "#EBEBE4");
                        $("#GvDecCompr_TxtNewDueDate_" + id + "").css("backgroundColor", "#EBEBE4");

                        var table = document.getElementById('GvDecCompr');
                        var IsSBM = $("#TxtIsSBMCmpr").val();
                        var EffDate = "";
                        var DueDate = "";
                        if (IsSBM.toString() == "1") {
                            EffDate = table.rows[(id + 1)].cells[11].innerHTML;
                        ...
                        $("#GvDecCompr_TxtNewEffDate_" + id + "").val(EffDate);
                        $("#GvDecCompr_TxtNewDueDate_" + id + "").val(DueDate);
                    }
                }
        ...
        function DatePitckerAppr(id) {
            try {
                (function ($) {
                    var GridViewName = $("#TxtGvName").val();
                    if (GridViewName == "GvDecision") {
                        $('#GvDecision_TxtNewEffDate_' + id).datetimepicker({
                            fontAwesome: 'font-awesome',
                            format: "dd/mm/yyyy",
                            autoclose: true,
                            todayBtn: true,
                            todayHighlight: true,
                            startDate: $("#GvDecision_TxtNewEffDate_" + id).val(),
                            minView: 2
                        });

                        $('#GvDecision_TxtNewDueDate_' + id).datetimepicker({
                            fontAwesome: 'font-awesome',
                            format: "dd/mm/yyyy",
                            autoclose: true,
                            todayBtn: true,
                        ...
                        $('#GvDecCompr_TxtNewEffDate_' + id).datetimepicker({
                            fontAwesome: 'font-awesome',
                            format: "dd/mm/yyyy",
                            autoclose: true,
                            todayBtn: true,
                            todayHighlight: true,
                            startDate: $("#GvDecCompr_TxtNewEffDate_" + id).val(),
                            minView: 2
                        });

                        $('#GvDecCompr_TxtNewDueDate_' + id).datetimepicker({
                            fontAwesome: 'font-awesome',
                            format: "dd/mm/yyyy",
                            autoclose: true,
                            todayBtn: true,
        ...
        function ValidateApproval() {
            try {
                var DefDueDate = $("#TxtDuenextRevDef").val();
                var GridViewName = $("#TxtGvName").val();
                if (GridViewName == "GvDecision") {
                    var IsValid = false;
                    ...
                    for (var i = 0 ; i < TotRecord; i++) {
                        ...
                        var IsSBM = $("#TxtIsSBM").val();
                        var RbRejSBMreverseDraft = $("#GvDecision_RbRejReverseToDraft_" + i + "");

                        var RbRejSBMreverseDraftVisible = false;
                        if (RbRejSBMreverseDraft != null) {
                            RbRejSBMreverseDraftVisible = $("#GvDecision_RbRejReverseToDraft_" + i + "").is(":visible");
                        }
                        ...
                        if (RbRejSBMreverseDraftVisible == true) {
                            if (Approv == false && Rej == false && RbRejSBMreverseDraft.prop("checked") == false) {
                                alert("please select Action Approv or Reject or Resubmit " + "\n" + "check data vendor:" + Vendor);
                                return false;
                                break;
                            }

                            if (RbRejSBMreverseDraft.prop("checked") == true && ReasonReject <= 0) {
                                alert("please select Reason Resubmit " + "\n" + "check data vendor:" + Vendor);
                                $("#GvDecision_DdlReject_" + i).css("backgroundColor", "#ffe6e6");
                                return false;
                                break;
                            }
                            if (RbRejSBMreverseDraft.prop("checked") == true && DdlValue == "Others" && RejRemark == "") {
                                alert("please enter Reason Resubmit " + "\n" + "check data vendor:" + Vendor);
                                $("#GvDecision_DdlReject_" + i).css("backgroundColor", "#ffe6e6");
                                return false;
                                break;
                            }
                            ...
                            if (RbRejSBMreverseDraft.prop("checked") == false && Rej == true && ReasonReject <= 0) {
                                alert("please select Reason rejection " + "\n" + "check data vendor:" + Vendor);
                                $("#GvDecision_DdlReject_" + i).css("backgroundColor", "#ffe6e6");
                                return false;
                                break;
                            }
                            if (RbRejSBMreverseDraft.prop("checked") == false && Rej == true && DdlValue == "Others" && RejRemark == "") {
                        ...
                        if (Approv == true && ChgDate == true) {
                            if (EffDate == "") {
                                ...
                                alert("Effective Date should not be Less than Due Date for Next Revision" + "\n" + "check data vendor:" + Vendor);
                                $("#GvDecision_TxtNewEffDate_" + i).css("backgroundColor", "#ffe6e6");
                                $("#GvDecision_TxtNewDueDate_" + i).css("backgroundColor", "#ffe6e6");
                                return false;
                                break;
                                ...
                                var strNewDueOn = document.getElementById("GvDecision_TxtNewDueDate_" + i).value.toString().replace(/\//g, '.');
                                var strDefDueOn = DefDueDate.toString().replace(/\-/g, '.');

                                if (strNewDueOn != "" && strDefDueOn != "") {
                                    var pattern = /(\d{2})\.(\d{2})\.(\d{4})/;
                                    var dtNewDueOn = new Date(strNewDueOn.replace(pattern, '$3-$2-$1'));
                                    var dtDefDueOn = new Date(strDefDueOn.replace(pattern, '$3-$2-$1'));

                                    if (dtNewDueOn < dtDefDueOn) {
                                        $("#GvDecision_TxtNewDueDate_" + i).css("backgroundColor", "#ffe6e6");
                                        alert("New Due On Cannot Small than Default Due Next Rev (" + strDefDueOn + ") ");
                                        return false;
                                        break;
                                    }
                                }
                    ...
                    for (var i = 0 ; i < TotRecord; i++) {
                        ...
                        var IsSBM = $("#TxtIsSBMCmpr").val();
                        var RbRejSBMreverseDraft = $("#GvDecCompr_RbRejReverseToDraft_" + i + "");
                        var RbRejSBMreverseDraftVisible = false;
                        if (RbRejSBMreverseDraft != null) {
                            RbRejSBMreverseDraftVisible = $("#GvDecCompr_RbRejReverseToDraft_" + i + "").is(":visible");
                        }
                        ...
                        if (Approv == true && ChgDate == true) {
                            if (EffDate == "") {
                                ...
                                var strNewDueOn = document.getElementById("GvDecCompr_TxtNewDueDate_" + i).value.toString().replace(/\//g, '.');
                                var strDefDueOn = DefDueDate.toString().replace(/\-/g, '.');
        ...
        function freezeheader() {
            try {
                (function ($) {
                    ...
                    if ($("#GvComMaterialpriceChange") != null) {
                        $("#GvComMaterialpriceChange").tableHeadFixer({ 'left': 10, head: true });
                    }
                    if ($("#GvComMaterialpriceChangeCmpr") != null) {
                        $("#GvComMaterialpriceChangeCmpr").tableHeadFixer({ 'left': 10, head: true });
                    }
                })(jQuery);
            }
            catch (err) {
        ...
        function OpenModalComMaterialpriceChange() {
            try {
                jQuery.noConflict();
                $("#myModalComMaterialpriceChange").modal({
                    backdrop: 'static',
                    keyboard: false
                });
            }
            catch (err) {
                alert(err + ' : myModalComMaterialpriceChange');
            }
        }
        function CloseModalComMaterialpriceChange() {
            try {
                jQuery.noConflict();
                $("#myModalComMaterialpriceChange").modal('hide');
            }
            catch (err) {
                alert(err + ' : myModalComMaterialpriceChange');
            }
        ...
        function FocusDecisonTabs() {
            try {
                jQuery.noConflict();
                (function ($) {
                    //$('#tabs').tabs('select', '#tabs2');
                    $('ul li a[href="#tabs-6"]').click();
                })(jQuery);
            }
            catch (err) {
                alert(err + " : FocusDecisonTabs()")
            }
        }
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-chart-area"></i>TEAM SHIMANO S.E.A. QUOTATION STATUS - <b>Manager Approval Pending</b>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <asp:Panel runat="server" DefaultButton="btnSearch">
                                        ...
                                        <div class="row" runat="server" id="DvFilterDiffrence" visible="false">
                                            <div class="col-lg-4" style="padding-bottom: 5px;">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <asp:Label runat="server" ID="Label15" Text="Diffrence"></asp:Label>
                                                    </div>
                                                    <div class="col-md-4 ">
                                            ...
                                            <div runat="server" id="DvMultiCondition" visible="false">
                                                <div class="col-lg-4" style="padding-bottom: 5px;">
                                                    <div class="group-main">
                                                        ...
                                                        <div class="SearchBox-txt">
                                                            <asp:TextBox runat="server" ID="TxtDiffrence1" onkeyup="IsNumber('TxtDiffrence1');" CssClass="text-right"></asp:TextBox>
                                                        </div>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true"
                                                ...
                                                <ContentTemplate>
                                                    <asp:GridView ID="GridView1" runat="server"
                                                        ...
                                                        CssClass="table-responsive  table-sm table-bordered  table-nowrap WrapCnt">
                                                        <Columns>
                                                            <%--Gridview Level 1--%>
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Panel ID="pnlDet" runat="server" Style="display: none">
                                                                        <asp:GridView ID="GvDet" runat="server" Font-Size="18px" AutoGenerateColumns="false" CssClass="table-bordered table-hover Padding-Nol"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="TotalMaterialCost" HeaderText="Material" ItemStyle-HorizontalAlign="Right"></asp:BoundField>
                                                                                ...
                                                                                <asp:BoundField DataField="UpdatedOn" HeaderText="Date"></asp:BoundField>
                                                                                ...
                                                                                <asp:BoundField DataField="ResponseStatus" HeaderText="Ven.Res.Status"></asp:BoundField>
                                                                            </Columns>
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="GdvMassRev" runat="server" ShowHeaderWhenEmpty="false" Width="100%" BackColor="White"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="QuoteResponseDueDate" HeaderText="Respon Date" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                                                <asp:BoundField DataField="Product" HeaderText="Product" SortExpression="Product" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                                                <asp:BoundField DataField="Material" HeaderText="Material" SortExpression="Material" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                                                <asp:BoundField DataField="MaterialDesc" HeaderText="Material Desc" SortExpression="MaterialDesc" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                                                ...
                                                                <asp:BoundField DataField="UpdatedOn" HeaderText="Updated Date" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                ...
                                <ContentTemplate>
                                    <div class="row" style="background-color: #F7F7F7; padding-bottom: 10px; padding-left: 10px; padding-right: 10px; box-shadow: 1px 1px 1000px 1px; border-top-left-radius: 10px; border-top-right-radius: 10px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
                                        <div class="col-md-12">
                                                ...
                                                <div class="col-lg-12 text-center" style="padding-top: 10px; padding-bottom: 10px;">
                                                    <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                                        <ContentTemplate>
                                                            ...
                                                            <asp:Label ID="Label8" runat="server" Text=" Manager Approval" Font-Size="Large"
                                                                ...
                                                                <asp:GridView ID="GvDecision" runat="server" AllowPaging="false" ShowHeaderWhenEmpty="true"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Change Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                                                                            <ItemTemplate>
                                                                                <asp:CheckBox ID="ChckChangeDate" runat="server" CssClass="mychk"></asp:CheckBox>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="New Effective Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                                                                            <ItemTemplate>
                                                                                <div class="group-main">
                                                                                    <asp:TextBox ID="TxtNewEffDate" OnclientClick="return false;" runat="server" Text='<%# Eval("EffectiveDate") %>' Width="100%"
                                                                                        ToolTip="Date To" onkeydown="javascript:preventInput(event);" autocomplete="off" Enabled="true"
                                                                                        CssClass="TxtGrid" AutoCompleteType="Disabled" ForeColor="Black">
                                                                                    </asp:TextBox>
                                                                                    <span class="SearchBox-btn-cal" style="background-color: #E9ECEF; padding: 2px 3px 2px 3px;">
                                                                                        <span class="fa fa-calendar" style="color: #005496;" id="IcnCalendarEff" runat="server"></span>
                                                                                    </span>
                                                                                </div>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="New Due Dt Next Rev" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                                                                            <ItemTemplate>
                                                                                <div class="group-main">
                                                                                    <asp:TextBox ID="TxtNewDueDate" OnclientClick="return false;" runat="server" Text='<%# Eval("DueOn") %>' Width="100%" Enabled="true"
                                                                                        CssClass="TxtGrid" ToolTip="Date To" onkeydown="javascript:preventInput(event);" autocomplete="off" AutoCompleteType="Disabled" ForeColor="Black">
                                                                                    </asp:TextBox>
                                                                                    <span class="SearchBox-btn-cal" style="background-color: #E9ECEF; padding: 2px 3px 2px 3px;">
                                                                                        <span class="fa fa-calendar" style="color: #005496;" id="IcnCalendarDue" runat="server"></span>
                                                                                    </span>
                                                                                </div>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:RadioButton ID="RbRejReverseToDraft" runat="server" Text="Resubmit" GroupName="RbDecision" />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="">
                                                                            <ItemTemplate>
                                            ...
                                            <div class="row" style="padding-top: 0px; background-color: white;" id="DvGridMatPriceChange" runat="server" visible="false">
                                                <div class="col-md-12">
                                                    <div class="col-lg-12 table table-responsive" style="padding: 0px;">
                                                        <asp:UpdatePanel ID="UpdatePanel25" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional" RenderMode="Block">
                                                            <ContentTemplate>
                                                                <asp:GridView ID="GvComMaterialpriceChange" runat="server" AllowPaging="false" ShowHeaderWhenEmpty="true"
                                                                    AutoGenerateColumns="False" OnRowDataBound="GvComMaterialpriceChange_RowDataBound"
                                                                    CssClass="table-responsive  table-sm table-bordered table-nowrap Padding-Nol WrapCnt">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="No.">
                                                                        ...
                                                                        <asp:BoundField DataField="PartCode" HeaderText="Part Code" ItemStyle-HorizontalAlign="Left" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                                                        <asp:BoundField DataField="PartCodeDesc" HeaderText="Part Code Desc" ItemStyle-HorizontalAlign="Left" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                                                        <asp:BoundField DataField="ComMaterial" HeaderText="Com Material" ItemStyle-HorizontalAlign="Left" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                                                        <asp:BoundField DataField="ComMaterialDesc" HeaderText="Com Material Desc" ItemStyle-HorizontalAlign="Left" HeaderStyle-CssClass="text-center"></asp:BoundField>

                                                                        <asp:BoundField DataField="EffectiveDate" HeaderText="Effective Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                                                        <asp:BoundField DataField="NewEffectiveDate" HeaderText="New Effective Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center"></asp:BoundField>

                                                                        <asp:BoundField DataField="AmtSCur" HeaderText="Amt SCur" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="Green"></asp:BoundField>
                                                                        <asp:BoundField DataField="SellingCrcy" HeaderText="Selling Crcy" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="Green"></asp:BoundField>
                                                                        <asp:BoundField DataField="AmtVCur" HeaderText="Amt VCur" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="Green"></asp:BoundField>
                                                                        <asp:BoundField DataField="VenorCrcy" HeaderText="Vendor Crcy" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="Green"></asp:BoundField>
                                                                        <asp:BoundField DataField="ValidFrom" HeaderText="Valid From" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="Green"></asp:BoundField>
                                                                        <asp:BoundField DataField="ValidTo" HeaderText="Valid To" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="Green"></asp:BoundField>

                                                                        <asp:BoundField DataField="NewAmtSCur" HeaderText="New Amt SCur" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="OrangeRed"></asp:BoundField>
                                                                        <asp:BoundField DataField="NewSellingCrcy" HeaderText="New Selling Crcy" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="OrangeRed"></asp:BoundField>
                                                                        <asp:BoundField DataField="NewAmtVCur" HeaderText="New Amt VCur" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="OrangeRed"></asp:BoundField>
                                                                        <asp:BoundField DataField="NewVenorCrcy" HeaderText="New Vendor Crcy" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="OrangeRed"></asp:BoundField>
                                                                        <asp:BoundField DataField="NewValidFrom" HeaderText="Valid From" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="OrangeRed"></asp:BoundField>
                                                                        <asp:BoundField DataField="NewValidTo" HeaderText="Valid To" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="OrangeRed"></asp:BoundField>
                                                                    </Columns>
                                                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                                                    <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
                                                                    <PagerSettings PageButtonCount="10" />
                                                        ...
                                                        <asp:Label runat="server" ID="LbMessage" ForeColor="Red" Font-Bold="true"
                                                            Text="Above Request have difference material price between previous effective date and  new effective date selected. Are you sure want to continue ?"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row pull-right" style="background: linear-gradient(90deg, #F5F5F5, #ffffff, #F5F5F5); border-top-left-radius: 15px; border-top-right-radius: 15px; padding-top: 10px; padding-bottom: 0px;">
                                                ...
                                                <asp:Button ID="BtnContinue" runat="server" Text="Continue" OnClientClick="ShowLoading();" OnClick="BtnContinue_Click" CssClass="btn btn-sm btn-warning" Font-Names="calibri" Font-Size="18px" Visible="false" />
                                                <div style="display: none;">
                                                    <asp:TextBox ID="TxtIsSBM" runat="server" Text=""></asp:TextBox>
                                                    <asp:TextBox ID="TxtPlantDec" runat="server" Text=""></asp:TextBox>
                                                    <asp:TextBox ID="TxtMaterialDec" runat="server" Text=""></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row" style="padding-top: 10px; background-color: white;">
                                                <div id="tabs" class="col-lg-12" style="padding: 0px 10px 0px 10px; border: none;">
                                                                                                        ...
                                                                                                        <asp:Panel ID="pnlDet" runat="server" Style="display: block">
                                                                                                            <asp:GridView ID="GvDetMatCost" runat="server" AutoGenerateColumns="false"
                                                                                                                ...
                                                                                                                <Columns>
                                                                                                                    ...
                                                                                                                    <asp:BoundField DataField="RawMaterialCost/kg" HeaderText="Raw MaterialCost / kg" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                                    ...
                                                    <div id="tabs-6" class="col-lg-12" style="border: 3px solid white; padding: 0px;">
                                                                                    ...
                                                                                    <ContentTemplate>
                                                                                        <asp:GridView ID="GvDecCompr" runat="server" AllowPaging="false" ShowHeaderWhenEmpty="true"
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="Change Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:CheckBox ID="ChckChangeDate" runat="server"></asp:CheckBox>
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField HeaderText="New Effective Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                                                                                                    <ItemTemplate>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="New Due Dt Next Rev" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                                                                                                    <ItemTemplate>
                                                                                                        <div class="group-main">
                                                                                                            <asp:TextBox ID="TxtNewDueDate" OnclientClick="return false;" runat="server" Text='<%# Eval("DueOn") %>' Width="100%"
                                                                                                                CssClass="TxtGrid" ToolTip="Date To" onkeydown="javascript:preventInput(event);" autocomplete="off" AutoCompleteType="Disabled" ForeColor="Black">
                                                                                                            </asp:TextBox>
                                                                                                            <span class="SearchBox-btn-cal" style="background-color: #E9ECEF; padding: 2px 3px 2px 3px;">
                                                                                                                <span class="fa fa-calendar" style="color: #005496;" id="IcnCalendarDue" runat="server"></span>
                                                        ...
                                                        <div class="row" style="padding-top: 0px; background-color: white;" id="DvGridMatPriceChangeCmr" runat="server" visible="false">
                                                            <div class="col-md-12">
                                                                <div class="col-lg-12 table table-responsive" style="padding: 0px;">
                                                                    <asp:UpdatePanel ID="UpdatePanel26" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional" RenderMode="Block">
                                                                        <ContentTemplate>
                                                                            <asp:GridView ID="GvComMaterialpriceChangeCmpr" runat="server" AllowPaging="false" ShowHeaderWhenEmpty="true"
                                                                                AutoGenerateColumns="False" OnRowDataBound="GvComMaterialpriceChange_RowDataBound"
                                                                                CssClass="table-responsive  table-sm table-bordered table-nowrap Padding-Nol WrapCnt">
                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                <Columns>
                                                                    ...
                                                                    <asp:Label runat="server" ID="Label16" ForeColor="Red" Font-Bold="true"
                                                                        Text="Above Request have difference material price between previous effective date and  new effective date selected. Are you sure want to continue ?"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row pull-right">
                                                            <div class="col-lg-12" style="padding-top: 5px; padding-bottom: 5px;">
                                                                ...
                                                                <asp:Button ID="BtnContinueCmp" runat="server" Text="Continue" OnClientClick="ShowLoading();" OnClick="BtnContinue_Click" CssClass="btn btn-sm btn-warning" Font-Names="calibri" Font-Size="18px" Visible="false" />
                                                                <div style="display: none;">
                                                                    <asp:TextBox ID="TxtIsSBMCmpr" runat="server" Text=""></asp:TextBox>
                                                                    <asp:TextBox ID="TxtPlantDecCmp" runat="server" Text=""></asp:TextBox>
                                                                    <asp:TextBox ID="TxtMaterialDecCmp" runat="server" Text=""></asp:TextBox>
                                                                    <asp:TextBox runat="server" ID="Txtlayout"></asp:TextBox>
                                                                    <asp:TextBox runat="server" ID="TxtDuenextRevDef"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
