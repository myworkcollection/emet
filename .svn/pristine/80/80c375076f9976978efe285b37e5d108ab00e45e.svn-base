<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VndMachineList.aspx.cs" Inherits="Material_Evaluation.VndMachineList" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-fw fa-list"></i><asp:Label runat="server" ID="LbVendorName"></asp:Label> : <b>Machine List</b>
