<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DesignChnge.aspx.cs" Inherits="Material_Evaluation.DesignChnge" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <table width="100%"   border="0" style="border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; background-color:rgba(0,0,0,.03);">
                    <tr>
                        ...
                        <td align="left">
                                   ...
                                   <%-- <asp:DropDownList ID="ddlplant" runat="server" AutoPostBack="true" Height="30px"
                                    ...
                                    <asp:TextBox ID="txtplant"  runat="server"  Font-Bold="True" 
                                        ForeColor="Black" Width="162px"></asp:TextBox>
                       ...
                       <tr>
                                ...
                                <ContentTemplate>
                                  <asp:TextBox ID="txtvendrID" runat="server" Height="30px" TextMode="MultiLine" Font-Bold="True" 
                                    ...
                                    <asp:AutoCompleteExtender ID="AutoCompleteExtender3" runat="server" CompletionInterval="1" CompletionListElementID="pnlPrdCode"
                                        ...
                                        TargetControlID="txtvendrID" UseContextKey="True">
                        ...
                        <td align="left">
                             <asp:DropDownList ID="ddlproduct" runat="server" Font-Bold="True"  Width="250px"
                    ...
                    <tr>
                        ...
                        <td >
                          ...
                          <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="ddlmatlclass" runat="server" AutoPostBack="true" 
                    ...
                    <tr>
                        ...
                        <td >
                             <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="txtpartdesc" runat="server" AutoPostBack="true" Height="30px" TextMode="MultiLine"
                    ...
                    <tr>
                        ...
                        <td  colspan="2">
                            &nbsp;<table >
                                <tr>
                                    <td>
                                        <asp:FileUpload ID="FileUpload1" runat="server" AllowMultiple="true" Height="24px"
                                            Width="216px" />
                    ...
                    <tr>
                     <td>
                        <asp:Label ID="Label5" runat="server"  Text="Comments :"
                                Width="150px" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td  align="left">
                            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="txtprocdesc" runat="server" AutoPostBack="true" Height="29px" 
                                        Width="250px"></asp:TextBox>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="txtjobtypedesc" runat="server" AutoPostBack="true" Height="29px"
                                        Width="250px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td >
                            <asp:TextBox ID="txtpartsurface" runat="server" Height="29px" Width="300px"></asp:TextBox> 
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="grdvendor" runat="server" AutoGenerateColumns="False" CellPadding="3"
                    ...
                    <tr>
                        ...
                        <td >
                            <asp:TextBox ID="txtproctype" runat="server" Width="300px"></asp:TextBox>
                        </td>
                        ...
                        <td >
                            <table >
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtPIRType" runat="server" Height="24px" Width="150px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPIRDesc" runat="server" Height="23px" Width="140px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td >
                            <asp:TextBox ID="txtSAPspProctype" runat="server" Width="300px"></asp:TextBox>
                        </td>
                        ...
                        <td >
                            <table >
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtunitweight" runat="server" Height="29px" Width="150px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtUOM" runat="server" Height="29px" Width="140px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnsave" runat="server" CssClass="Login-button" Text="Create Request"
                                            Width="150px" PostBackUrl="DesignChange_Request.aspx" />
                                    </td>
                                    <td>
