<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeVendor_Request.aspx.cs" Inherits="Material_Evaluation.ChangeVendor_Request" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
       ...
       <%-- <li class="nav-item dropdown">
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                <!-- Breadcrumbs-->
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Change of Vendor Request</a> </li>
                </ol>
                <!-- Icon Cards-->
                <div class="row">
                </div>
                ...
                <div class="card mb-3">
                   ...
                   <%-- <tr>
                        <td>
                            <asp:Label ID="lblunit" runat="server"  Font-Bold="True" ForeColor="Black" Text="Part Net Unit Weight(g):"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtunit" runat="server" Height="27px" Width="150px" 
                                 Font-Bold="True" ForeColor="Black"></asp:TextBox>
                        </td>
                   
                        <td>
                            <asp:Label ID="Label9" runat="server"  Font-Bold="True" ForeColor="Black" Text="Cavity:"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtcavity" runat="server" Height="27px" Width="150px" 
                                 Font-Bold="True" ForeColor="Black"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label8" runat="server"  Font-Bold="True" ForeColor="Black" Text="Material Yield/Meltting Loss(%):"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtmatlyield" runat="server" Height="27px" Width="150px" 
                                 Font-Bold="True" ForeColor="Black"></asp:TextBox>
                        </td>
                   
                        <td>
                            <asp:Label ID="Label11" runat="server"  Font-Bold="True" ForeColor="Black" Text="Material Gross Weight/pc (g):"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtmatlgroswgt" runat="server" Height="27px" Text="" 
                                Width="150px"  Font-Bold="True" ForeColor="Black"></asp:TextBox>
                        </td>
                    </tr>--%>
                  
                    <tr>
                        <td colspan="4">
                           <%-- <div style="height: 150px; width: 350px; left: 100px; overflow: auto;" >--%>
                  ...
                  <%--   <tr>
                        <td>
                            <asp:Label ID="Label27" runat="server"  Font-Bold="True" ForeColor="Black" Text="Total material cost/pcs ($) :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txttotmatl" runat="server" Width="200px"  
                                Font-Bold="True" ForeColor="Black" CssClass="tetxboxcolor" Height="27px" ></asp:TextBox>
                        </td>
                   
                        <td>
                            <asp:Label ID="Label28" runat="server"  Font-Bold="True" ForeColor="Black" Text="Total Process Cost/pcs ($):"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txttotproc" runat="server" Width="200px"  
                                Font-Bold="True" ForeColor="Black" CssClass="tetxboxcolor" Height="27px"></asp:TextBox>
                        </td>
                    </tr>
                     <tr>
                        <td>
                            <asp:Label ID="Label29" runat="server"  Font-Bold="True" ForeColor="Black" Text="Total Sub-Mat/T&J Cost/pcs ($) :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txttotsub" runat="server" Width="200px"  
                                Font-Bold="True" ForeColor="Black" CssClass="tetxboxcolor" Height="27px"></asp:TextBox>
                        </td>
                  

                        <td>
                            <asp:Label ID="Label30" runat="server"  Font-Bold="True" ForeColor="Black" Text="Total Other Item Cost/pcs ($) :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txttotother" runat="server" Width="200px"  
                                Font-Bold="True" ForeColor="Black" CssClass="tetxboxcolor" Height="27px"></asp:TextBox>
                        </td>
                         </tr>
 ...
 <tr>
                        <td>
                            <asp:Label ID="Label31" runat="server"  Font-Bold="True" ForeColor="Black" Text="Grand Total Cost/pcs ($) :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtgrandtot" runat="server" Width="200px"  
                                Font-Bold="True" ForeColor="Black" CssClass="tetxboxcolor" Height="27px"></asp:TextBox>
                        </td>
                        
                        <td>
                            <asp:Label ID="Label32" runat="server"  Font-Bold="True" ForeColor="Black" Text="Final Quote Price/pcs ($) :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtfinalquote" runat="server" Width="200px" 
                                 Font-Bold="True" ForeColor="Black" CssClass="tetxboxcolor" 
 ...
 <tr>
                        <td>
                            <asp:Label ID="Label33" runat="server"  Font-Bold="True" ForeColor="Black" Text="Profit (%) :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtprofit" runat="server" Width="200px"  
                                Font-Bold="True" ForeColor="Black" Height="27px" ></asp:TextBox>
                        </td>

                        
                        <td>
                            <asp:Label ID="Label34" runat="server"  Font-Bold="True" ForeColor="Black" Text="Discount (%) :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtdiscount" runat="server" Width="200px"  
                                Font-Bold="True" ForeColor="Black" Height="27px"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label35" runat="server"  Font-Bold="True" ForeColor="Black" Text="Final Quote Price/pcs :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtfinal" runat="server" Width="200px"  
                                Font-Bold="True" ForeColor="Black" CssClass="tetxboxcolor" Height="27px"></asp:TextBox>
                        </td>
                        <td>
                        </td>
