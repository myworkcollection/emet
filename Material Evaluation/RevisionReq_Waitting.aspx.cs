...
{
    public partial class RevisionReq_Waitting : System.Web.UI.Page
    {
        public string MHid;
            ...
            try
            {
                ...
                else
                {
                    if (!Page.IsPostBack)
                    {
                        ...
                        string FN = "EMET_RevisionReqWaitting";
            ...
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    sql = @" select distinct Plant,RequestNumber,CONVERT(VARCHAR(10), RequestDate, 103) as RequestDate, 
                            ...
                            and isUseSAPCode = 1
                            and Plant  = '" + Session["EPlant"].ToString() + "' and A.QuoteNoRef is not null ";
            ...
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    sql = @" select VendorCode1,VendorName,QuoteNo,'" + RowParentGv + @"' as ParentGvRowNo from TQuoteDetails 
                            where RequestNumber not in(select distinct RequestNumber from TQuoteDetails where ApprovalStatus = 2 or ApprovalStatus = 1 or ApprovalStatus = 3  or ApprovalStatus is  null) 
                            and isnull(CreateStatus,'') <> '' and RequestNumber = '" + RequestNumber + "' and QuoteNoRef is not null ";
                    if (txtFind.Text != "")
                    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "Approve")
                {
                    ...
                    TxtMaterial.Text = row.Cells[7].Text;
            ...
            try
            {
                ...
                if (Status == 1)
                {
                    ...
                    if (Reason.ToString() != "")
                    {
                        try
                        {
                            ...
                            string str1 = "Update TQuoteDetails SET ApprovalStatus='" + 1 + "', PICApprovalStatus = '" + 1 + "', ManagerApprovalStatus= '" + 1 + "', DIRApprovalStatus= '" + 1 + "', PICReason = '" + pic + "', ManagerReason = '" + pic + "', DIRReason = '" + pic + "', UpdatedBy='" + userID + "', UpdatedOn='" + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss") + "' where RequestNumber = '" + ReqNum + "'";
                ...
                if (Status == 2)
                {
                    try
                    {
                        ...
                        string str = "Update TQuoteDetails SET ApprovalStatus='" + 3 + "',PICApprovalStatus = '" + Status + "', ManagerApprovalStatus = '" + Status + "', DIRApprovalStatus = '" + Status + "', PICReason = '" + Reason + "', ManagerReason = '" + Reason + "', DIRReason = '" + Reason + "', UpdatedBy='" + userID + "', UpdatedOn='" + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss") + "' where RequestNumber = '" + ReqNum + "' and VendorCode1 ='" + Vendor + "'";
                        ...
                        string pic = nameC.ToString() + " - " + Reason.ToString();
                        str = "Update TQuoteDetails SET ApprovalStatus='" + 3 + "',PICApprovalStatus = '" + Status + "',  ManagerApprovalStatus = '" + Status + "', DIRApprovalStatus = '" + Status + "', PICReason = '" + pic + "', ManagerReason = '" + pic + "', DIRReason = '" + pic + "', UpdatedBy='" + userID + "', UpdatedOn='" + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss") + "' where RequestNumber = '" + ReqNum + "' and VendorCode1 ='" + Vendor + "'";
