...
{
    public partial class NewReq_changes : System.Web.UI.Page
    {
        public string MHid;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                        ...
                        else
                        {
                            ...
                            if (!string.IsNullOrEmpty(Request.QueryString["Number"]))
                            {
                                ...
                                GetData(QuoteNo);
                                TurnKeyprovit();
                                Countryoforigin(QuoteNo);
                                GetSubMatDdl();
                                GetOthCostDdl();

                                IsMassrevision(QuoteNo);
                                if (Session["IsMassRevision"].ToString() == "1") {
                                ...
                                else if (Isrevision(QuoteNo) == true)
                                {
                                    hdnRevOfEmet.Value = "1";
                                    GetQuoteandAllDetails(QuoteNo);
                                    GetDataMachineAmor();
                                    GetQuoteDetailsbyQuotenumber(QuoteNo);
                                    CreateDynamicTablebasedonProcessField();
                                ...
                                else
                                {
                                    ...
                                    {
                                        RetrieveAllCostDetailsMassRevision(QuoteNo);
                                        MCCostDataStore();
                                    }
                                ...
                                {
                                    if (Session["IsRevision"].ToString() == "1")
                                    {
                                        TableUnit.Enabled = false;
                                    }
                                    else
                                    {
                                        TableUnit.Enabled = true;
                                    }
                                }
                    ...
                    else
                    {
                        ...
                        //System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "freezeheader();", true);
                    }
                }
            }
            ...
            {
                //Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "window.Dispose();", true);
            }
        }
        ...
        bool Isrevision(string QuNo)
        {
            ...
            try
            {
                ...
                {
                    sql = @" select distinct QuoteNoRef,AcsTabMatCost,AcsTabProcCost,AcsTabSubMatCost,AcsTabOthMatCost,NetProfDisc 
        ...
        protected void SetTitleForm(string QN)
        {
            try
            {
                ...
                {
                    lbTitle.Text = "Quote Request Without SAP Code : New";
                }
                else if (QN.Substring(QN.Length - 2, 2) == "GP")
                {
                    lbTitle.Text = "Quote Request Without SAP Code (GP) : New";
                }
                else
                {
                    lbTitle.Text = "Quote Request With SAP Code : New";
                }
        ...
        protected void GetGA()
        {
            if (hdnQuoteNoRef.Value.ToString() == "")
            {
                SqlConnection MDMCon = new SqlConnection(EMETModule.GenMDMConnString());
                try
                {
                    MDMCon.Open();
                    sql = @"select GA,Profit from TSBMPRICINGPOLICY where VendorCode=@VendorCode and Plant=@Plant and CostHeader=@CostHeader";
                    ...
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            ProfitSBM = reader["Profit"].ToString();
                        }
                    }
                }
                catch (Exception ex)
            ...
            else
            {
                ...
                {
                    EmetCon.Open();
                    sql = @"select GA,Profit from TQuoteDetails where QuoteNo=@QuoteNo";
        ...
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "AllRecalculate();RestoreDataTbaleUnit();", true);
            ...
            System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "ComntByVendorLght();", true);
        }
        ...
        protected void Countryoforigin(string Quno)
        {
            SqlConnection MDMCon = new SqlConnection(EMETModule.GenMDMConnString());
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    cmd.Parameters.AddWithValue("@Quno", Quno);
                    sda.SelectCommand = cmd;
                    sda.Fill(Result);
                }
        ...
        protected void GetDataPrcGroupVsStukMin()
        {
            ...
            try
            {
                ...
                if (hdnProcGroup.Value.Trim() != "" && hdnMachineType.Value.Trim() != "" && hdnTonnage.Value.Trim() != "") {
                    ...
                    {
                        cmd = new SqlCommand(str, MDMCon);
                        cmd.Parameters.AddWithValue("@strplant", strplant);
                        cmd.Parameters.AddWithValue("@Process_Grp_code", hdnProcGroup.Value);
                        cmd.Parameters.AddWithValue("@MachineType", hdnMachineType.Value);
                        cmd.Parameters.AddWithValue("@Tonnage", hdnTonnage.Value);
                        sda.SelectCommand = cmd;
        ...
        protected string GetDataMacTypNtoonageRetrive(string MachineID)
        {
            ...
            try
            {
                ...
                string strplant = Session["strplant"].ToString();
                string str = @" select MachineType,Tonnage from TVENDORMACHNLIST 
                            where Plant=@strplant and MachineID= @MachineID and DELFLAG = 0  ";
        ...
        protected string IsFollowStdRate(string ProcGroup, string MachineId)
        {
            string FollowStdRate = "N";
            SqlConnection MDMCon = new SqlConnection(EMETModule.GenMDMConnString());
            try
            {
                MDMCon.Open();
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    cmd.Parameters.AddWithValue("@VendorCode", Session["mappedVendor"].ToString());
                    cmd.Parameters.AddWithValue("@Plant", strplant);
                    cmd.Parameters.AddWithValue("@ProcessGrp", strplant);
                    cmd.Parameters.AddWithValue("@MachineID", MachineId);
                    sda.SelectCommand = cmd;
                    sda.Fill(DtDataStdrRate);
                }
                if (DtDataStdrRate.Rows.Count > 0)
                {
                    FollowStdRate = DtDataStdrRate.Rows[0]["FollowStdRate"].ToString();
                }
                else
                {
                    hdnStdrRate.Value = "";
        ...
        protected void GetDataDataVndmachine()
        {
            ...
            try
            {
                ...
                string str = @" select TVM.MachineID as MacId, CONCAT(LTRIM(RTRIM(TVM.MachineID)),' - ',LTRIM(RTRIM(TVM.MachineDescription))) as Machine, 
                                ...
                                where TVM.VendorCode = @VendorCode 
                                and Plant = @Plant and ProcessGrp= @ProcessGrp and TVM.DELFLAG = 0 ";
        ...
        protected void GetDataVndmachine2(string ProcGroup)
        {
            ...
            try
            {
                ...
                string str = @" select CONCAT(LTRIM(RTRIM(TVM.MachineID)),' - ',LTRIM(RTRIM(TVM.MachineDescription))) as MachineID 
                                ...
                                from TVENDORMACHNLIST TVM 
                                where TVM.VendorCode = @VendorCode and Plant = @Plant
                                and ProcessGrp= @ProcessGrp and TVM.DELFLAG = 0";
                DtDataMacVnd = new DataTable();
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    cmd = new SqlCommand(str, MDMCon);
        ...
        private void GetQuoteandAllDetails(string QuoteNo)
        {
            ...
            try
            {
                ...
                string str = @"select top 1 A.RequestNumber,RequestDate,A.QuoteNo,Plant,MaterialType,PlantStatus
                                ...
                                left join TMngEffDateChgLog B on A.QuoteNo = B.QuoteNo where A.QuoteNo=@QuoteNo and A.CreateStatus ='Article' 
                ...
                if (dtdate.Rows.Count > 0)
                {
                    ...
                    if (dtdate.Rows[0]["isMassRevision"].ToString() == "True")
                    {
                        ...
                        if (ddlpirjtype.Items.Count > 0)
                        {
                            if (dtdate.Rows[0]["CountryOrg"].ToString() != "")
                            {
                                ddlpirjtype.SelectedValue = dtdate.Rows[0]["CountryOrg"].ToString();
                            }
                        }
                    ...
                    if (Session["IsUseToolAmortize"].ToString() == "1" || Session["IsUseToolAmortize"].ToString() == "True" && dtdate.Rows[0]["QuoteNoRef"].ToString() == "")
                    {
                        GetDataToolAmor(dtdate.Rows[0]["QuoteNo"].ToString());
                    }
                    else if (Session["IsUseToolAmortize"].ToString() == "1" || Session["IsUseToolAmortize"].ToString() == "True" && dtdate.Rows[0]["QuoteNoRef"].ToString() != "")
                    {
                        GetDataToolAmor(dtdate.Rows[0]["QuoteNo"].ToString(), dtdate.Rows[0]["QuoteNoRef"].ToString());
                    }
                    else
                    {
                        if (dtdate.Rows[0]["QuoteNoRef"].ToString() != "")
                        {
                            ...
                            HdnIsUseToolAmortize.Value = "0";
                            Session["VndToolAmortize"] = null;
                        }
                    }

                    if ((dtdate.Rows[0]["IsUseMachineAmortize"].ToString() == "1" || dtdate.Rows[0]["IsUseMachineAmortize"].ToString() == "True") && dtdate.Rows[0]["QuoteNoRef"].ToString() == "")
                    {
                        HdnIsUseMachineAmor.Value = "1";
                        GetDataMachineAmorRevision(QuoteNo);
                        Session["IsMacAmorAdded"] = true;
                    }
                    else if ((dtdate.Rows[0]["IsUseMachineAmortize"].ToString() == "1" || dtdate.Rows[0]["IsUseMachineAmortize"].ToString() == "True") && dtdate.Rows[0]["QuoteNoRef"].ToString() != "") {
                        GetDataMachineAmorRevision(QuoteNo, dtdate.Rows[0]["QuoteNoRef"].ToString());
                        //Session["IsMacAmorAdded"] = true;
                    }
                    else if ((dtdate.Rows[0]["IsUseMachineAmortize"].ToString() == "0" || dtdate.Rows[0]["IsUseMachineAmortize"].ToString() == "False") && dtdate.Rows[0]["QuoteNoRef"].ToString() != "")
                    {
                        GetDataMachineAmorRevision(QuoteNo, dtdate.Rows[0]["QuoteNoRef"].ToString());
                        //Session["IsMacAmorAdded"] = true;
                    }
        ...
        protected void GetDataToolAmor(string QuoteNo, string QuoteNoRef = "",bool Generatevalue = true)
        {
            ...
            try
            {
                ...
                {
                    Session["VndToolAmortize"] = MyDta;
                    TxtIsUseToolAmor.Text = "YES";
                }
                else
                {
                    Session["VndToolAmortize"] = null;
                    TxtIsUseToolAmor.Text = "NO";
                }
        ...
        protected void GetDataMachineAmor()
        {
            SqlConnection MdmCon = new SqlConnection(EMETModule.GenMDMConnString());
            try
            {
        ...
        protected void GetDataMachineAmorRevision(string QuoteNo, string QuoteNoRef = "", bool Generatevalue = true)
        {
            GetDbMaster();
            SqlConnection EmetCon = new SqlConnection(EMETModule.GenEMETConnString());
            try
            {
                ...
                if (QuoteNoRef != "") {
                    ...
                    {
                        sql = @" select distinct TM.Plant,TM.VendorCode,TM.VendorCurrency,TM.Process_Grp_code,TM.Vend_MachineID,TV.MachineDescription
                    ,isnull(CONVERT(DECIMAL(10,2),TM.AmortizeCost),0) as AmortizeCost,TM.AmortizeCurrency,TM.ExchangeRate
                    ,isnull(CONVERT(DECIMAL(10,2),tm.AmortizeCost_Vend_Curr),0) as AmortizeCost_Vend_Curr
                    ,TM.AmortizePeriod,TM.AmortizePeriodUOM,TM.TotalAmortizeQty,TM.QtyUOM,TM.AmortizeCost_Pc_Vend_Curr
                    ,format(TM.EffectiveFrom,'yyyy-MM-dd') as EffectiveFrom,format(TM.DueDate,'yyyy-MM-dd') as DueDate,1 as OldMacAmor
                    from  TMachineAmortization TM 
                    left join " + DbMasterName + @".dbo.TVENDORMACHNLIST TV on tm.Plant = tv.Plant and tm.VendorCode = tv.VendorCode and tm.Vend_MachineID = tv.MachineID and tm.Process_Grp_code = tv.ProcessGrp and ISNULL(tv.IsAmortize_Machine,0) = 1
                    Where QuoteNo = @QuoteNo
                    ORDER BY TM.Vend_MachineID";
                        ...
                        using (DataTable dt = new DataTable())
                        {
                            sda.Fill(dt);
                            MyDta = dt;
                            Session["OldMachineAmorList"] = MyDta;
                        }
                    }
                }
                ...
                if (MyDta.Rows.Count > 0)
                {
                    //GvMachineAmor.DataSource = MyDta;
                    //GvMachineAmor.DataBind();
                    Session["VndMachineAmortize"] = MyDta;
                    HdnIsUseMachineAmor.Value = "1";
                }
                else
                {
        ...
        protected void showDataQuoreReqRevice(string newQN, string OldQN)
        {
            ...
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    sql = @" select iif(@newQN = @OldQN,'',QuoteNo) as QuoteNo,TQ.CountryOrg,TQ.CommentByVendor,
                    ...
                    using (DataTable dt = new DataTable())
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            TxtComntByVendor.Text = dt.Rows[0]["CommentByVendor"].ToString();
        ...
        protected void CountryoforiginRev(string QuNo)
        {
            SqlConnection EmetCon = new SqlConnection(EMETModule.GenEMETConnString());
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    sql = @" select distinct TQ.CountryOrg from TQuoteDetails TQ  where TQ.QuoteNo = @QuoteNo ";
                    ...
                    using (DataTable dt = new DataTable())
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ddlpirjtype.SelectedValue = dt.Rows[0]["CountryOrg"].ToString();
        ...
        private void GetQuoteupdated(string QuoteNo)
        {
            ...
            try
            {
                MDMCon.Open();
                DataTable dtdate = new DataTable();
                string str = "select useid,usenam from usr where useid=@useid and DELFLAG = 0 ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    cmd = new SqlCommand(str, MDMCon);
                        ...
                        for (int cellCtr = 1; cellCtr <= DtDynamic.Rows.Count; cellCtr++)
                        {
                            ...
                            for (int i = 0; i <= 1; i++)
                            {
                                ...
                                else
                                {
                                    ...
                                    #region ExtraTextbox for raw material cost UOM and Total Mat Cost
                                    ...
                                    if (DtDynamic.Rows[cellCtr - 1].ItemArray[0].ToString().Trim().TrimEnd().TrimStart().Replace(" ", "") == "RawMaterialCost/kg")
                                    {
                                        ...
                                        ddlRawMaterialCostUOM.ID = "ddlRawMaterialCostUOM" + (columncountbyType);
                                        ...
                                        if (Session["uomlist"] != null)
                                        {
                                            ...
                                            ddlRawMaterialCostUOM.Attributes.Add("onchange", "SetTotaRawMatCostAndUOM(" + columncountbyType + ")");
                                            ...
                                            if (DtMaterialsDetails.Rows.Count > 0)
                                            {
                                                if (ColumnType <= DtMaterialsDetails.Rows.Count)
                                                {
                                                    ...
                                                    //string ddltemval = DtMaterialsDetails.Rows[ColumnType].ItemArray[6].ToString();
                                    ...
                                    //tb2.ID = "txtRawMaterialCostUOM" + (columncountbyType);
                                    ...
                                    //tb2.Attributes.Add("onkeyup", "isincludecomma('" + tb2.ID.ToString() + "');SetTotaRawMatCostAndUOM(" + columncountbyType + ");");
                                    ...
                                    tb3.ID = "txtTotRawMaterialCostUOM" + (columncountbyType);
                                    ...
                                    if (tb.ID.Contains("TotalRawMaterialCost/g") || tb.ID.Contains("txtPartNetUnitWeight(g)") || tb.ID.Contains("MaterialGrossWeight/pc(g)") || 
                                        tb.ID.Contains("MaterialCost/pcs") || tb.ID.Contains("TotalMaterialCost/pcs") || tb.ID.Contains("RunnerRatio/pcs(%)") ||  tb.ID.Contains("txtScrapRebate/pcs") || tb.ID.Contains("txtMaterialScrapWeight(g)") )
                                    {
                                            ...
                                            if (ii == rowcountnew)
                                            {
                                                if (tb.ID.Contains("txtTotalMaterialCost/pcs"))
                                                {
                                                    if (HdnFirsLoad.Value == "1")
                                                    {
                                                        if (hdnMassRevision.Value != "")
                                                        {
                                                            tb.Text = HdnMAssTotMatCost.Value;
                                                        }
                                                        else
                                                        {
                                                            tb.Text = "";
                            ...
                            for (int cellCtr = 0; cellCtr <= DtMaterialsDetails.Rows.Count; cellCtr++)
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        #region SAPSpProcType Condition
                                        else if (HdnSAPSpProcType.Value == "30")
                                        {
                                            if (HdnAcsTabMatCost.Value == "False")
                                            {
                                                BtnDel.Attributes.Add("style", "display:none;");
                                ...
                                for (int cellCtr = 0; cellCtr <= DtMaterialsDetails.Rows.Count; cellCtr++)
                                {
                                    ...
                                    if (cellCtr == 0)
                                    {
                                        ...
                                        if (hdnLayoutScreen.Value == "Layout7")
                                        {
                                            ...
                                            if (row.ItemArray[0].ToString().Replace(" ", "").ToUpper().Contains("/PCS"))
                                            {
                                                lb.Text = DtDynamic.Rows[cellCtr - 1].ItemArray[0].ToString().Replace("Yield", "").Replace("~", "").Replace("~~", "").Replace("/pcs", "/UOM").Replace("/ kg", "/ UOM");
                                            }
                                        }
                                    ...
                                    else
                                    {
                                        ...
                                        DropDownList ddlRawMaterialCostUOM = new DropDownList();
                                        if (row.ItemArray[0].ToString().Trim().TrimEnd().TrimStart().Replace(" ", "") == "RawMaterialCost/kg")
                                        {
                                            DataTable dtUOMList = (DataTable)Session["uomlist"];
                                            ddlRawMaterialCostUOM.ID = "ddlRawMaterialCostUOM" + (cellCtr - 1);
                                            ddlRawMaterialCostUOM.Style.Add("max-width", "100px;");
                                            ddlRawMaterialCostUOM.Attributes.Add("class", "pull-right");
                                            ...
                                            if (Session["uomlist"] != null)
                                            {
                                                ...
                                                ddlRawMaterialCostUOM.DataTextField = "uomlist";
                                                ddlRawMaterialCostUOM.DataValueField = "uomlist";
                                                ddlRawMaterialCostUOM.Attributes.Add("onchange", "SetTotaRawMatCostAndUOM(" + (cellCtr - 1) + ")");
                                                ddlRawMaterialCostUOM.DataBind();
                                                ...
                                                if (DtMaterialsDetails.Rows.Count > 0)
                                                {
                                                    ...
                                                    {
                                                        ddlRawMaterialCostUOM.Attributes.Add("disabled", "disabled");
                                                        string ddltemval = DtMaterialsDetails.Rows[cellCtr - 1].ItemArray[7].ToString();
                                                        var ddlcheck = ddlRawMaterialCostUOM.Items.FindByText(ddltemval);
                                                        if (ddlcheck != null)
                                                        {
                                                            ddlRawMaterialCostUOM.SelectedValue = ddltemval;
                                        ...
                                        //TextBox tb2 = new TextBox();
                                        //tb2.BorderStyle = BorderStyle.None;
                                        //tb2.ID = "txtRawMaterialCostUOM" + (cellCtr - 1);
                                        //tb2.Attributes.Add("autocomplete", "off");
                                        //tb2.Style.Add("max-width", "50px;");
                                        //tb2.Attributes.Add("placeholder", "UOM");
                                        //tb2.Style.Add("text-transform", "uppercase");
                                        //tb2.Attributes.Add("onkeydown", "return (event.keyCode!=13);");
                                        //tb2.Attributes.Add("onkeyup", "isincludecomma('" + tb2.ID.ToString() + "');SetTotaRawMatCostAndUOM(" + (cellCtr - 1) + ");");
                                        //tb2.Attributes.Add("class", "pull-right");
                                        //tb2.Style.Add("text-align", "left");
                                        ...
                                        TextBox tb3 = new TextBox();
                                        tb3.BorderStyle = BorderStyle.None;
                                        tb3.ID = "txtTotRawMaterialCostUOM" + (cellCtr - 1);
                                        tb3.Attributes.Add("autocomplete", "off");
                                        tb3.Style.Add("max-width", "50px;");
                                        tb3.Attributes.Add("placeholder", "UOM");
                                        tb3.Style.Add("text-transform", "uppercase");
                                        ...
                                        {
                                            double RawVal = 0;
                                            if (DtMaterialsDetails.Rows[cellCtr - 1].ItemArray[4].ToString() != "")
                                            {
                                                RawVal = Double.Parse(DtMaterialsDetails.Rows[cellCtr - 1].ItemArray[4].ToString());
                                                tb.Attributes.Add("disabled", "disabled");
                                                //tb2.Attributes.Add("disabled", "disabled");
                                            }

                                            if (DtMaterialsDetails.Rows[cellCtr - 1]["UOM"].ToString().ToUpper() == "KG")
                                            {
                                                double rawperkg = RawVal / 1000;
                                                tb.Text = (String.Format("{0:0.000}", rawperkg));
                                            }
                                            else
                                            {
                                                tb.Text = (RawVal.ToString("#.000"));
                                            }
                                            
                                            //tb2.Text = DtMaterialsDetails.Rows[cellCtr - 1]["UOM"].ToString();
                                            // tb.Enabled = false;
                                        ...
                                        {
                                            double RawVal = 0;
                                            if (DtMaterialsDetails.Rows[cellCtr - 1].ItemArray[6].ToString() != "")
                                            {
                                                RawVal = Double.Parse(DtMaterialsDetails.Rows[cellCtr - 1].ItemArray[4].ToString());
                                                tb.Attributes.Add("disabled", "disabled");
                                                //tb2.Attributes.Add("disabled", "disabled");
                                            ...
                                            {
                                                double rawperkg = RawVal / 1000;
                                                float TotRawMat = float.Parse(rawperkg.ToString()) / 1000;
                                                string TotRawMatStrFormat = String.Format("{0:0.0000}", TotRawMat); ;
                                                tb.Text = TotRawMatStrFormat;
                                                tb3.Text = "G";
                                            }
                                            else
                                            {
                                                tb.Text = (RawVal.ToString("#.000"));
                                                tb3.Text = DtMaterialsDetails.Rows[cellCtr - 1]["UOM"].ToString();
                                            }
                                            // tb.Enabled = false;
                                        ...
                                        else if (tb.ID.Contains("TotalRawMaterialCost/g") || tb.ID.Contains("MaterialGrossWeight/pc(g)") || tb.ID.Contains("MaterialCost/pcs") || tb.ID.Contains("RunnerRatio/pcs(%)") || tb.ID.Contains("txtScrapRebate/pcs") || tb.ID.Contains("txtMaterialScrapWeight(g)"))
                                        {
                                            tb.Attributes.Add("disabled", "disabled");
                                        }
                                        ...
                                        if (cellCtr > 1)
                                        {
                                            if (tb.ID.Contains("RunnerWeight/shot(g)") || tb.ID.Contains("RunnerRatio/pcs(%)") || tb.ID.Contains("MaterialGrossWeight/pc(g)") || tb.ID.Contains("PartNetUnitWeight(g)") || tb.ID.Contains("TotalMaterialCost/pcs") || tb.ID.Contains("RecycleMaterialRatio(%)") || tb.ID.Contains("Cavity") || tb.ID.Contains("MaterialYield/MeltingLoss(%)"))
                                            {
                                                if (hdnLayoutScreen.Value != "Layout5")
                                                {
                                                    int CellsCount = Table1.Rows.Count - 1;
                                                    Table1.Rows[CellsCount].Cells[1].Attributes.Add("colspan", CellsCount.ToString());
                                                    ((System.Web.UI.WebControls.WebControl)(Table1.Rows[CellsCount].Cells[1].Controls[0])).Style.Add("width", "-webkit-fill-available");
                                                    ((System.Web.UI.WebControls.WebControl)(Table1.Rows[CellsCount].Cells[1].Controls[0])).Style.Add("text-align", "center");
                                                }
                                                else
                                                {
                                                    tCell.Controls.Add(tb);
                                            ...
                                            else
                                            {
                                                if (tb.ID.Contains("txtRawMaterialCost/kg"))
                                                {
                                                    tb.Style.Add("max-width", "100px;");
                                                    tCell.Controls.Add(tb);
                                                    //tCell.Controls.Add(tb2);
                                                }
                                                else if(tb.ID.Contains("txtTotalRawMaterialCost/g"))
                                                {
                                                    tb.Style.Add("max-width", "150px;");
                                                    tCell.Controls.Add(tb);
                                                    tCell.Controls.Add(tb3);
                                                }
                                                else
                                        ...
                                        #region SAPSpProcType Condition
                                        if (tb.ID.Contains("txtMaterialCost/pcs"))
                                        {
                                            if (HdnSAPSpProcType.Value == "30")
                                            {
                                                if (HdnAcsTabMatCost.Value == "False")
                                    ...
                                    else
                                    {
                                        ...
                                        if (DtDynamic.Rows[cellCtr - 1].ItemArray[0].ToString().Trim().TrimEnd().TrimStart().Replace(" ", "") == "RawMaterialCost/kg")
                                        {
                                            ...
                                            if (Session["uomlist"] != null)
                                            {
                                                ...
                                                if (ArrRwMatUom.Count() >= Clm && ArrRwMatUom.Count() > 1)
                                                {
                                                    string ddltemval = ArrRwMatUom[Clm - 1].ToString().Replace("NaN", "").ToUpper();
                                                    var ddlcheck = ddlRawMaterialCostUOM.Items.FindByText(ddltemval);
                                                    if (ddlcheck != null)
                                                    {
                                                        //ddlRawMaterialCostUOM.Items.FindByText(ddltemval).Selected = true;
                                        ...
                                        if (tb.ID.Contains("TotalRawMaterialCost/g") || tb.ID.Contains("txtPartNetUnitWeight(g)") || tb.ID.Contains("MaterialGrossWeight/pc(g)") || tb.ID.Contains("MaterialCost/pcs") || tb.ID.Contains("TotalMaterialCost/pcs") || tb.ID.Contains("RunnerRatio/pcs(%)") || tb.ID.Contains("txtScrapRebate/pcs") || tb.ID.Contains("txtMaterialScrapWeight(g)"))
                                        {
                                            if (tb.ID.Contains("txtPartNetUnitWeight(g)"))
                                            {
                                                tb.Text = txtPartUnit.Value;
                            ...
                            else
                            {
                                ...
                                if (DtDynamic.Rows[cellCtr - 1].ItemArray[0].ToString().Trim().TrimEnd().TrimStart().Replace(" ", "") == "RawMaterialCost/kg")
                                {
                                    ...
                                    if (Session["uomlist"] != null)
                                    {
                                        ...
                                        if (ArrRwMatUom.Count() >= Clm && ArrRwMatUom.Count() > 1)
                                        {
                                            string ddltemval = ArrRwMatUom[i].ToString().Replace("NaN", "").ToUpper();
                                            var ddlcheck = ddlRawMaterialCostUOM.Items.FindByText(ddltemval);
                                            if (ddlcheck != null)
                                            {
                                                //ddlRawMaterialCostUOM.Items.FindByText(ddltemval).Selected = true;
                                    ...
                                    for (int ii = 0; ii < TempMClistNew.Count; ii++)
                                    {
                                        if (ii == (cellCtr - 1))
                                        {
                                            ...
                                            else if (tb.ID.Contains("txtTotalRawMaterialCost/g"))
                                            {
                                                ...
                                                if (ArrRwMatUom.Count() >= Clm)
                                                {
                                                    if (ArrRwMatUom[Clm].ToString().Replace("NaN", "").ToUpper() == "KG")
                                                    {
                                                        tb3.Text = "G";
                                                    }
                                                    else
                                                    {
                                                        tb3.Text = ArrRwMatUom[Clm].ToString().Replace("NaN", "");
                                                    }
                                                }
                                            }
                                            else
                        ...
                        for (int cellCtr = 0; cellCtr <= DtDynamicProcessCostsDetails.Rows.Count; cellCtr++)
                        {
                            ...
                            if (cellCtr == 0)
                            {
                                ...
                                else if (row.ItemArray[0].ToString().Replace(" ", "").ToUpper().Contains("EFFICIENCY/PROCESSYIELD(%)"))
                                {
                                    ...
                                    if (hdnLayoutScreen.Value == "Layout7")
                                    {
                                        tCell.Text = row.ItemArray[0].ToString().Replace("/pcs", "/UOM");
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                ...
                                else if (row.ItemArray[0].ToString().Trim().TrimEnd().TrimStart().Replace(" ", "").Contains("IfTurnkey-Subvendorname"))
                                {
                                    ...
                                    ddl.Style.Add("min-width", "300px;");
                                    DataTable ResultSubVndName = (DataTable)Session["SubVndorData"];
                                    ddl.DataSource = ResultSubVndName;
                                                ...
                                                if (ii == rowcount)
                                                {
                                                    if (tempPClist[2].ToString() == "" || tempPClist[2].ToString() == null)
                                                    {
                                                        ...
                                                        if (tempPClist[3].ToString() == "" || tempPClist[3].ToString() == null)
                                                        {
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                if (tempPClist[8].ToString().Trim().ToUpper().Replace(" ", "") == "CYCLETIMEINSEC" && ii == 9)
                                                                {
                                                                    tb.Attributes.Remove("disabled");
                                                                }
                                                    ...
                                                    if (tb.ID.Contains("txtTotalProcessesCost/pcs"))
                                                    {
                                                        if (HdnFirsLoad.Value == "1")
                                                        {
                                                            if (hdnMassRevision.Value != "")
                                                            {
                                                                tb.Text = HdnMAssTotProcCost.Value;
                                                            }
                                                            else
                                                            {
                                                                tb.Text = "";
        ...
        private void CreateDynamicSubMaterialDT(int ColumnType)
        {
            try
            {
                ...
                if (ColumnType == 0)
                {
                    ...
                    bool isOri = false;
                    TableRow Hearderrow = new TableRow();
                    bool isHaveOldToolAmortize = false;
                    ...
                    for (int cellCtr = 0; cellCtr <= 1; cellCtr++)
                    {
                        ...
                        else
                        {
                            ...
                            if (Session["VndToolAmortize"] != null)
                            {
                                ...
                                {
                                    if (dtTollAmot.Rows[cellCtr - 1]["OldToolAmor"].ToString() == "1")
                                    {
                                        LbToolOrMachineAmor.Text = "Old Tool Amortize";
                                        isHaveOldToolAmortize = true;
                                    }
                                    else
                                    {
                    ...
                    if (isHaveOldToolAmortize == true)
                    {
                        TableSMC.Rows[0].Cells[1].BackColor = ColorTranslator.FromHtml("#cc2900");
                    }
                    else
                    {
                        TableSMC.Rows[0].Cells[1].BackColor = ColorTranslator.FromHtml("#1a2e4c");
                    }
                        ...
                        for (int i = 0; i <= 1; i++)
                        {
                            ...
                            else
                            {
                                ...
                                if (DtDynamicSubMaterialsFields.Rows[cellCtr - 1].ItemArray[0].ToString().Trim().TrimEnd().TrimStart().Replace(" ", "") == "Sub-Mat/T&JDescription")
                                {
                                    ...
                                    if (hdnSMCTableValues.Value != null && hdnSMCTableValues.Value != "")
                                    {
                                        ...
                                        for (int ii = 0; ii < tempPClist.Count; ii++)
                                        {
                                            if (ii == (cellCtr - 1))
                                            {
                                                ...
                                                var ddlcheck = ddl.Items.FindByText(tempPClist[ii].ToString().Replace("NaN", ""));
                                                bool Isfound = false;
                                                for (int g = 0; g < ddl.Items.Count; g++)
                                                {
                                                    string item = ddl.Items[g].ToString();
                                                    if (item == ddltemval)
                                                    {
                                                        ddl.ClearSelection();
                                                        ddl.Items[g].Selected = true;
                                                        Isfound = true;
                                                        isOri = true;
                                                        FirstDdlVal = ddltemval;
                                                        break;
                                                    }
                                                }
                                                ...
                                                else
                                                {
                                                    ...
                                                    else if (dtMachineAmor.Rows.Count > 0)
                                                    {
                                                        string ItemValue = dtMachineAmor.Rows[0]["Vend_MachineID"].ToString();
                                                        string ItemText = (dtMachineAmor.Rows[0]["Vend_MachineID"].ToString() + "-" + dtMachineAmor.Rows[0]["MachineDescription"].ToString());
                                                        ListItem lst = new ListItem(ItemText, ItemValue);
                                                        ddl.Items.Insert(ddl.Items.Count, lst);
                                                        ddl.SelectedValue = ItemValue;
                                                        ddl.Enabled = false;
                                                    ...
                                                    {
                                                        if (tempPClist[ii].ToString().Replace("NaN", "") != "")
                                                        {
                                    ...
                                    if (isOri == true) {
                                        ddl.SelectedIndex = ddl.Items.IndexOf(ddl.Items.FindByValue(FirstDdlVal));
                                        string ItemValue = FirstDdlVal;
                                        string ItemText = FirstDdlVal;
                                        ListItem lst = new ListItem(ItemText, ItemValue);
                                        ddl.Items.Insert(ddl.Items.Count, lst);
                                        ddl.SelectedValue = FirstDdlVal;
                                    }
                                    tCell.Controls.Add(ddl);
                                }
                                else
                                            ...
                                            if (ii == (cellCtr - 1))
                                            {
                                                if (tb.ID.Contains("txtTotalSub-Mat/T&JCost/pcs"))
                                                {
                                                    if (HdnFirsLoad.Value == "1")
                                                    {
                                                        if (hdnMassRevision.Value != "")
                                                        {
                                                            tb.Text = HdnMAssTotSubMatCost.Value;
                                                        }
                                                        else
                                                        {
                                                            tb.Text = "";
                    ...
                    for (int i = 1; i < CellsCount; i++)
                    {
                        ...
                        for (int cellCtr = 0; cellCtr <= DtDynamicSubMaterialsFields.Rows.Count; cellCtr++)
                        {
                            ...
                            if (cellCtr == 0)
                            {
                                ...
                                int DataMacAmorCount = dtMachineAmor.Rows.Count;

                                if (Session["VndToolAmortize"] != null)
                                {
                                    dtTollAmot = (DataTable)Session["VndToolAmortize"];
                                    int DataToolCount = dtTollAmot.Rows.Count;
                                    if (DataToolCount > 0 && i < DataToolCount)
                                    {
                                        BtnDel.Attributes.Add("style", "display:none;");
                                    ...
                                    else if (DataMacAmorCount > 0 && (DataToolCount + DataMacAmorCount) > i && HdnIsUseMachineAmor.Value == "1")
                                    {
                                        int r = i - dtTollAmot.Rows.Count;
                                        if (dtMachineAmor.Rows[r]["OldMacAmor"].ToString() == "1")
                                        {
                                            LbToolOrMachineAmor.Text = "Old Machine Amortize";
                                            TableSMC.Rows[0].Cells[ColmNoSubMat - 1].BackColor = ColorTranslator.FromHtml("#cc2900");
                                        }
                                        else
                                        {
                                            LbToolOrMachineAmor.Text = "Machine Amortize";
                                            TableSMC.Rows[0].Cells[ColmNoSubMat - 1].BackColor = ColorTranslator.FromHtml("#1a2e4c");
                                        }
                                        BtnDel.Attributes.Add("style", "display:none;");
                                        tCell.Controls.Add(LbToolOrMachineAmor);
                                    }
                                ...
                                {
                                    if (DataMacAmorCount > 0 && DataMacAmorCount > i)
                                    {
                                        if (dtMachineAmor.Rows[(ColmNoSubMat - DataMacAmorCount)]["OldMacAmor"].ToString() == "1")
                                        {
                                            LbToolOrMachineAmor.Text = "Old Machine Amortize";
                                            TableSMC.Rows[0].Cells[ColmNoSubMat - 1].BackColor = ColorTranslator.FromHtml("#cc2900");
                                        }
                                            ...
                                            if (ii == (cellCtr - 1))
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (Session["VndToolAmortize"] != null)
                                                    {
                                                        ...
                                                        {
                                                            if (TempSMClistNew[ii].ToString().Replace("NaN", "") != "")
                                                            {
                                            ...
                                            if (ii == (cellCtr - 1))
                                            {
                                                ...
                                                if (tb.ID.Contains("TotalOtherItemCost/pcs"))
                                                {
                                                    if (HdnFirsLoad.Value == "1")
                                                    {
                                                        if (hdnMassRevision.Value != "")
                                                        {
                                                            tb.Text = HdnMAssTotOthCost.Value;
                                                        }
                                                        else
                                                        {
                                                            tb.Text = "";
                        ...
                        for (int i = 0; i <= 5; i++)
                        {
                            ...
                            else if (i == 1)
                            {
                                ...
                                else
                                {
                                    ...
                                    #region SAPSpProcType Condition
                                    if (tb.ID.Contains("txtTotalMaterialCost/pcs-0"))
                                    {
                                        if (HdnSAPSpProcType.Value == "30")
                                        {
                                            if (HdnAcsTabMatCost.Value == "False")
                            ...
                            else if (i == 3)
                            {
                                ...
                                if (a.Contains("TotalProcessesCost/pcs-"))
                                {
                                    ...
                                    tb.Attributes.Add("onblur", "ValOnlyNo('txtDiscount(%)0','RedirectTxt')");
                                    tb.Style.Add("text-align", "right");
                                    if (hdnUnitValues.Value != null && hdnUnitValues.Value != "")
                                    {
                                        for (int z = 1; z <= DtDynamicUnitFields.Rows.Count; z++)
                            ...
                            else if (i == 5)
                            {
                                ...
                                if (a.Contains("GrandTotalCost/pcs"))
                                {
                                    ...
                                    tb.Attributes.Add("onkeyup", "isincludecomma('" + tb.ID.ToString() + "');");
                                    tb.Style.Add("text-align", "right");
                                    if (hdnRevOfEmet.Value == "1") {
                                        if (HdnNetProfnDisc.Value != "") {
                                            tb.Text = HdnNetProfnDisc.Value + " %";
                                        }
                                    }
                                    TableUnit.Rows[cellCtr].Cells.Add(tCell);
                                }
                        ...
                        for (int i = 0; i <= 4; i++)
                        {
                            ...
                            else if (i == 2)
                            {
                                ...
                                if (a.Contains("GrandTotalCost/pcs"))
                                {
                                    ...
                                    tb.Attributes.Add("onchange", "ValOnlyNo('GA(%)0','RedirectTxt')");
                                    tb.Style.Add("text-align", "right");
                                    tb.Text = GA.ToString();
                                    TableUnit.Rows[cellCtr].Cells.Add(tCell);
                                }
        ...
        protected void GetData(string reqno)
        {
            ...
            try
            {
                ...
                strGetData = @"select CONVERT(VARCHAR(10), s.RequestDate, 103) as RequestDate,S.QuoteNo,V.Description,v.Crcy,vp.PICName,vp.PICemail from tVendor_New as V inner join TVENDORPIC as VP
                    on vp.VendorCode=v.Vendor inner join " + TransDB.ToString() + @"TQuoteDetails as S on S.VendorCode1=v.Vendor 
        ...
        private void GetSHMNPICDetails(string userdet)
        {
            ...
            try
            {
                ...
                {
                    str1 = "select distinct PP.PIC1Name as PICName,pp.PIC1Email as PICEmail from TSMNProductPIC pp inner join " + TransDB.ToString() + "TQuotedetails TQ on pp.Userid = Tq.CreatedBy where QuoteNo=@QuoteNo ";
                }
                else
                {
                    str1 = "select distinct PP.PIC1Name as PICName,pp.PIC1Email as PICEmail,pp.Product from TSMNProductPIC pp inner join " + TransDB.ToString() + "TQuotedetails TQ on pp.Product = TQ.Product and pp.Userid = Tq.CreatedBy and PP.Product = TQ.Product where QuoteNo=@QuoteNo and pp.DELFLAG = 0 ";
                }
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
        ...
        protected void process()
        {
            ...
            try
            {
                ...
                string strSubVndName = @"select distinct CONCAT( TKV.SubVendor, ' - ', TVN.Description) as SubVndorData  
                                    from TTURNKEY_VENDOR TKV join tVendor_New TVN on TKV.SubVendor = TVN.Vendor 
                ...
                Session["SubVndorData"] = ResultSubVndName;
                #endregion
                ...
                string str1 = @"select TVM.MachineID as MacId, CONCAT(TVM.MachineID, ' - ', TVM.MachineDescription) as Machine
                    , CAST(ROUND(TVM.SMNStdrateHr,2) AS DECIMAL(12,2))as 'SMNStdrateHr' ,TVM.FollowStdRate  as FollowStdRate,TVM.Currency as Currency
                    , TVM.ProcessGrp as ProcessGrp 
                    from TVENDORMACHNLIST TVM where TVM.VendorCode = @VendorCode and Plant = @Plant and TVM.DELFLAG = 0 ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    cmd = new SqlCommand(str1, MDMCon);
                    cmd.Parameters.AddWithValue("@VendorCode", Session["mappedVendor"].ToString());
                ...
                from TVENDORMACHNLIST TVM where VendorCode = @VendorCode  and Plant = @Plant and TVM.DELFLAG = 0 ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
        ...
        protected void btnAddSubProcessCost_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                subMatCostDataStore();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "freezeheader();submatlcost();", true);
                //DataTable DtDynamicSubMaterialsFields = new DataTable();
                //DtDynamicSubMaterialsFields = (DataTable)Session["DtDynamicSubMaterialsFields"];
                ...
                //System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "submatlCostDataStore();freezeheader();", true);
            }
            catch (Exception ex)
            {
                LbMsgErr.Text = ex.StackTrace.ToString() + " - " + ex.Message.ToString(); DvMsgErr.Visible = true;
        ...
        protected void BtnDelSubMatCost_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //        }
                //    }
                //    System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "submatlcost();freezeheader();", true);
                //}
            }
            catch (Exception ex)
            {
        ...
        protected void btnAddOtherCost_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "OthersCostDataStore();freezeheader();", true);
                //CreateDynamicOthersCostDT(0);
                //OthersAddCount++;
                //CreateDynamicOthersCostDT(OthersAddCount);
            }
        ...
        protected void BtnDelOthCost_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "othercost();freezeheader();", true);
                }
            ...
            try
            {
                ...
                if (hdnOtherValues.Value != null && hdnOtherValues.Value != "")
                {
                    ...
                    for (int i = 1; i <= ccc; i++)
                    {
                        ...
                        sql = @"insert into [dbo].[TOtherCostDetails] (QuoteNo,ProcessGroup,ItemsDescription,[OtherItemCost/pcs],[TotalOtherItemCost/pcs],RowId,UpdatedBy,UpdatedOn)
                            VALUES (@QuoteNo,@PG,@Desc,@Cost,@TotalCost,@RowId,@By,@On)";
                ...
                if (hdnSMCTableValues.Value != null && hdnSMCTableValues.Value != "")
                {
                    ...
                    for (int i = 1; i <= ccc; i++)
                    {
                        ...
                        if (isInsert == true)
                        {
                            sql = @"insert into [dbo].[TSMCCostDetails] (QuoteNo,ProcessGroup,[Sub-Mat/T&JDescription],[Sub-Mat/T&JCost],[Consumption(pcs)]
                            ,[Sub-Mat/T&JCost/pcs],[TotalSub-Mat/T&JCost/pcs],RowId,UpdatedBy,UpdatedOn) VALUES (@QuoteNo,@PG,@Desc,@Cost,@IConsumption,@ICostpcs,@ItotalCost,@RowId,@By,@On)";
                ...
                if (hdnProcessValues.Value != null && hdnProcessValues.Value != "")
                {
                    ...
                    for (int i = 1; i <= ccc; i++)
                    {
                        ...
                        sql = @"insert into [dbo].[TProcessCostDetails] (QuoteNo,ProcessGroup,[ProcessGrpCode],[SubProcess],[IfTurnkey-VendorName],[Machine/Labor]
                            ,[Machine],[StandardRate/HR] ,[VendorRate],[ProcessUOM],[Baseqty],[DurationperProcessUOM(Sec)],[Efficiency/ProcessYield(%)]
                            ,[ProcessCost/pc],[TotalProcessesCost/pcs],RowId,UpdatedBy,UpdatedOn,TurnKeySubVnd,TurnKeyCost,TurnKeyProfit) 
                            VALUES (@QuoteNo,@PG,@IProc,@ISubProc,@ITurnKey,@IMachineLabor,@IMachine,@IStRate,@IVendorRate,@IProcUOM,@IBaseQty
                            ,@IDPUOM,@Iyield,@ICostPc,@ITotalCost, @RowId,@By,@On,@ITurnKeySubVnd,@ITurnKeyCost,@ITurnKeyProfit)";
                ...
                sql = @" update TQuoteDetails SET  TotalMaterialCost = @TMCost, TotalSubMaterialCost = @TSMCost, TotalProcessCost =@TPCost
                                ...
                                Profit = @TProfit,Discount = @TDiscount,NetProfDisc = @NetProfDisc,GA = @TGA, 
                ...
                cmd.Parameters.AddWithValue("@QuoteNo", hdnQuoteNo.Value);
                cmd.Parameters.AddWithValue("@NetProfDisc", HdnNetProfnDisc.Value.ToString() == "" ? DBNull.Value.ToString() : HdnNetProfnDisc.Value.ToString());
            ...
            try
            {
                ...
                if (hdnOtherValues.Value != null && hdnOtherValues.Value != "")
                {
                    ...
                    for (int i = 1; i <= ccc; i++)
                    {
                        ...
                        sql = @"insert into [dbo].[TOtherCostDetails_D] (QuoteNo,ProcessGroup,ItemsDescription,[OtherItemCost/pcs],[TotalOtherItemCost/pcs],RowId,UpdatedBy,UpdatedOn) 
                                VALUES (@QuoteNo,@PG,@Desc,@Cost,@TotalCost,@RowId,@By,@On)";
                ...
                if (hdnSMCTableValues.Value != null && hdnSMCTableValues.Value != "")
                {
                    ...
                    for (int i = 1; i <= ccc; i++)
                    {
                        ...
                        if (isInsert == true)
                        {
                            string sql = @"insert into [dbo].[TSMCCostDetails_D] (QuoteNo,ProcessGroup,[Sub-Mat/T&JDescription],[Sub-Mat/T&JCost],[Consumption(pcs)],[Sub-Mat/T&JCost/pcs]
                                            ,[TotalSub-Mat/T&JCost/pcs],RowId,UpdatedBy,UpdatedOn) VALUES (@QuoteNo,@PG,@Desc,@Cost,@IConsumption,@ICostpcs,@ItotalCost,@RowId,@By,@On)";
                            cmd = new SqlCommand(sql, EmetCon, EmetTrans);
                            cmd.Parameters.AddWithValue("@QuoteNo", hdnQuoteNo.Value);
                            cmd.Parameters.AddWithValue("@PG", txtprocs.Text.ToString());
                            cmd.Parameters.AddWithValue("@Desc", IDesc);
                ...
                if (hdnProcessValues.Value != null && hdnProcessValues.Value != "")
                {
                    ...
                    for (int i = 1; i <= ccc; i++)
                    {
                        ...
                        string UserId = Session["userID_"].ToString();
                        string sql = @"insert into [dbo].[TProcessCostDetails_D] (QuoteNo,ProcessGroup,[ProcessGrpCode],[SubProcess],[IfTurnkey-VendorName],[Machine/Labor],[Machine]
                                ,[StandardRate/HR] ,[VendorRate],[ProcessUOM],[Baseqty],[DurationperProcessUOM(Sec)],[Efficiency/ProcessYield(%)],[ProcessCost/pc],[TotalProcessesCost/pcs]
                                ,RowId,UpdatedBy,UpdatedOn,TurnKeySubVnd,TurnKeyCost,TurnKeyProfit) 
                                VALUES (@QuoteNo,@PG,@IProc,@ISubProc,@ITurnKey,@IMachineLabor,@IMachine,@IStRate,@IVendorRate,@IProcUOM
                                ,@IBaseQty,@IDPUOM,@Iyield,@ICostPc,@ITotalCost, @RowId,@By,@On,@ITurnKeySubVnd,@ITurnKeyCost,@ITurnKeyProfit)";
                ...
                else
                {
                    sqlInsr = @" insert into TQuoteDetails_D (RequestNumber,RequestDate,QuoteNo,Plant,MaterialType,PlantStatus,SAPProcType,SAPSpProcType,Product,
                                    ...
                                    PICRejReason,PICRejRemark,IsReSubmit,IMRecycleRatio,MassRevQutoteRef,IsUseToolAmortize,IsUseMachineAmortize,ToolAmorRemark,MachineAmorRemark,isMassRevisionAll)
        ...
        private void RetrieveAllCostDetails()
        {
            ...
            try
            {
                ...
                strGetData = @"SELECT QuoteNo,ProcessGroup,UPPER(ItemsDescription) as 'ItemsDescription',[OtherItemCost/pcs] as 'OtherItemCost/pcs'
                            ,CAST(ROUND([TotalOtherItemCost/pcs],5) AS DECIMAL(12,5)) as 'TotalOtherItemCost/pcs',RowId FROM TOtherCostDetails 
                            Where  QuoteNo = @QuoteNoRef order by RowId asc ";
                cmd = new SqlCommand(strGetData, EmetCon);
                if (Session["IsMassRevision"].ToString() == "1" && hdnQuoteNoRef.Value == "")
                {
                    cmd.Parameters.AddWithValue("@QuoteNoRef", hdnQuoteNo.Value);
                }
                else {
                    cmd.Parameters.AddWithValue("@QuoteNoRef", hdnQuoteNoRef.Value);
                }
                ...
                strsub = @"SELECT QuoteNo,ProcessGroup,UPPER([Sub-Mat/T&JDescription]) as 'Sub-Mat/T&JDescription',[Sub-Mat/T&JCost] as 'Sub-Mat/T&JCost',[Consumption(pcs)] as 'Consumption(pcs)',
                            [Sub-Mat/T&JCost/pcs] as 'Sub-Mat/T&JCost/pcs',CAST(ROUND([TotalSub-Mat/T&JCost/pcs],5) AS DECIMAL(12,5)) as 'TotalSub-Mat/T&JCost/pcs',RowId from TSMCCostDetails 
                            Where  QuoteNo = @QuoteNoRef  ";

                if (HdnAcsTabSubMatCost.Value == "True" && HdnIsUseToolAmortize.Value == "0")
                {
                    strsub += @" and [Sub-Mat/T&JDescription] not in (select Amortize_Tool_ID from TToolAmortization where QuoteNo=@QuoteNoRef) --and RowId = 1";
                }
                else if ((HdnIsUseToolAmortize.Value != "0" || HdnIsUseToolAmortize.Value != "")) {
                    if (Session["VndToolAmortize"] != null) {
                        DataTable MyDataToolAmor = (DataTable)Session["VndToolAmortize"];
                        if (MyDataToolAmor.Rows.Count > 0) {
                            string ToolId = "";
                            for (int i = 0; i < MyDataToolAmor.Rows.Count; i++) {
                                ToolId += "'" + MyDataToolAmor.Rows[i]["Amortize_Tool_ID"].ToString() + "',";
                            }

                            if (ToolId != "") {
                                ToolId = ToolId.Remove(ToolId.Length-1,1);
                                strsub += @" and [Sub-Mat/T&JDescription] not in ("+ ToolId + ") ";
                            }
                        }
                    }
                }
                strsub += @" order by RowId asc ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                ...
                if (dtget.Rows.Count > 0)
                {
                    if (Session["VndToolAmortize"] != null) {
                        ...
                        if (MyDataToolAmor.Rows.Count > 0) {
                            ...
                            for (int i = 0; i < MyDataToolAmor.Rows.Count; i++)
                            {
                                var txtsubDesc = MyDataToolAmor.Rows[i]["Amortize_Tool_ID"].ToString();
                                //var txtsubcost = MyDta.Rows[i]["AmortizeCost"].ToString();
                                var txtsubcost = MyDataToolAmor.Rows[i]["AmortizeCost_Vend_Curr"].ToString();
                                var txtConsumption = MyDataToolAmor.Rows[i]["TotalAmortizeQty"].ToString();
                                var txtsubcostPC = MyDataToolAmor.Rows[i]["AmortizeCost_Pc_Vend_Curr"].ToString();
                                for (int c = 0; c < MyDataToolAmor.Rows.Count; c++)
                                {
                                    TotCostPc = TotCostPc + decimal.Parse(MyDataToolAmor.Rows[i]["AmortizeCost_Pc_Vend_Curr"].ToString());
                                }
                                decimal txtTotalCostPC = TotCostPc;
                                sbSub.Append(txtsubDesc + "," + txtsubcost + "," + txtConsumption + "," + txtsubcostPC + "," + String.Format("{0:0.00000}", txtTotalCostPC) + ",");
                            }
                ...
                strProcess = @"SELECT PCD.[QuoteNo],PCD.[ProcessGroup],PCD.[ProcessGrpCode],PCD.[SubProcess],PCD.[IfTurnkey-VendorName]
                                ...
                                ,PCD.[RowId],PCD.[UpdatedBy],PCD.[UpdatedOn] FROM  [TProcessCostDetails] PCD  Where PCD.[QuoteNo] = @QuoteNoRef order by RowId asc ";
                ...
                strMCIM = @"SELECT TMC.QuoteNo,TMC.ProcessGroup,UPPER(MaterialSAPCode) as 'MaterialSAPCode',UPPER(MaterialDescription) as 'MaterialDescription',[RawMaterialCost/kg] as 'RawMaterialCost/kg',
                        ...
                        Where  TMC.QuoteNo = @QuoteNoRef order by RowId asc ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                ...
                if (dtget.Rows.Count > 0)
                {
                    ...
                    {
                        DtBomData = (DataTable)Session["DtMaterialsDetails"];
                        if (DtBomData.Rows.Count > 0)
                        {
                            if (DtBomData.Rows.Count > dtget.Rows.Count)
                            {
                                ColumnNeed = DtBomData.Rows.Count;
                            }
                            else
                            {
                                ColumnNeed = dtget.Rows.Count;
                            }
                        }
                        else
                        {
                    ...
                    for (var i = 0; i < ColumnNeed; i++)
                    {
                        bool useBomData = false;
                        if (DtBomData.Rows.Count > 0)
                        {
                            if (i < DtBomData.Rows.Count)
                            {
                                strMCode = DtBomData.Rows[i]["material"].ToString();
                                strMDesc = DtBomData.Rows[i]["MaterialDesc"].ToString();

                                decimal rwmatCost = 0;
                                if (DtBomData.Rows[i]["UOM"].ToString().ToUpper() == "KG")
                                {
                                    rwmatCost = Convert.ToDecimal(DtBomData.Rows[i]["AmtScur"].ToString()) / 1000;
                                    strRawCost = rwmatCost.ToString("0.000");
                                    decimal totrwmat = rwmatCost / 1000;
                                    strTotalRawCost = totrwmat.ToString("0.0000");
                                }
                                else
                                {
                                    rwmatCost = Convert.ToDecimal(DtBomData.Rows[i]["AmtScur"].ToString());
                                    strRawCost = rwmatCost.ToString("0.000");
                                    strTotalRawCost = rwmatCost.ToString("0.0000");
                                }

                                strRawMaterialUOM = DtBomData.Rows[i]["UOM"].ToString();
                ...
                strUnitData = @"select CAST(ROUND(TotalMaterialCost,5) AS DECIMAL(12,5)) as 'TotalMaterialCost',
                            ...
                            CAST(ROUND(GrandTotalCost,5) AS DECIMAL(12,5)) as 'GrandTotalCost',
                            Profit,Discount,
                            CAST(ROUND(FinalQuotePrice,5) AS DECIMAL(12,5)) as 'FinalQuotePrice',CommentByVendor from TQuoteDetails  Where QuoteNo = @QuoteNoRef";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
        ...
        private void RetrieveAllCostDetailsMassRevision(string QuNo)
        {
            SqlConnection EmetCon = new SqlConnection(EMETModule.GenEMETConnString());
            SqlConnection MDMCon = new SqlConnection(EMETModule.GenMDMConnString());
            try
            {
                ...
                strGetData = @"SELECT QuoteNo,ProcessGroup,UPPER(ItemsDescription) as 'ItemsDescription',[OtherItemCost/pcs] as 'OtherItemCost/pcs'
                ,CAST(ROUND([TotalOtherItemCost/pcs],5) AS DECIMAL(12,5)) as 'TotalOtherItemCost/pcs',RowId FROM FROM TOtherCostDetails 
                Where  QuoteNo = @QuoteNoRef order by RowId asc ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    cmd = new SqlCommand(strGetData, EmetCon);
                    cmd.Parameters.AddWithValue("@QuoteNoRef", QuNo);
                    sda.SelectCommand = cmd;
                    sda.Fill(dtget);
                }
                ...
                strProcess = @"SELECT PCD.[QuoteNo],PCD.[ProcessGroup],PCD.[ProcessGrpCode],PCD.[SubProcess],PCD.[IfTurnkey-VendorName]
                                ...
                                ,PCD.[TurnKeyCost],PCD.[TurnKeyProfit],PCD.[ProcessCost/pc]
                                ,iif(isnull(PCD.[TotalProcessesCost/pcs],'')= '','',convert(nvarchar(12),CAST(ROUND(PCD.[TotalProcessesCost/pcs],5) AS DECIMAL(12,5)))) as [TotalProcessesCost/pcs]
                                ,PCD.[RowId],PCD.[UpdatedBy],PCD.[UpdatedOn] FROM  [TProcessCostDetails_D] PCD  Where PCD.[QuoteNo] = @QuoteNoRef order by RowId asc ";
                    ...
                    for (var i = 0; i < dtget.Rows.Count; i++)
                    {
                        ...
                        if (txtProcUOM.ToString().Contains("STROKES/MIN"))
                        {
                            try
                            {
                                ...
                                string strplant = Session["strplant"].ToString();
                                string str1 = @" select Plant,Process_Grp_code,MachineType,Tonnage_From,Tonnage_To,Strokes_min,Efficiency from TPROCESSGRPVSSTROKES_MIN  
                                            where Plant=@Plant and Process_Grp_code=@Process_Grp_code and MachineType=@MachineType and (@tonnage between Tonnage_From and Tonnage_To) ";
                                cmd = new SqlCommand(str1, MDMCon);
                                cmd.Parameters.AddWithValue("@Plant", strplant);
                                cmd.Parameters.AddWithValue("@Process_Grp_code", Process_Grp_code);
                                cmd.Parameters.AddWithValue("@MachineType", MachineType);
                ...
                strMCIM = @"SELECT QuoteNo,ProcessGroup,UPPER(MaterialSAPCode) as 'MaterialSAPCode',UPPER(MaterialDescription) as 'MaterialDescription',[RawMaterialCost/kg] as 'RawMaterialCost/kg',
                        ...
                        CAST(ROUND([MaterialGrossWeight/pc(g)],5) AS DECIMAL(12,4)) as 'MaterialGrossWeight/pc(g)', [MaterialScrapWeight(g)] as 'MaterialScrapWeight(g)', [ScrapLossAllowance(%)] as 'ScrapLossAllowance(%)',
                        [ScrapPrice/kg] as 'ScrapPrice/kg', [ScrapRebate/pcs] as 'ScrapRebate/pcs', [MaterialCost/pcs] as 'MaterialCost/pcs', CAST(ROUND([TotalMaterialCost/pcs],5) AS DECIMAL(12,5)) as 'TotalMaterialCost/pcs',
                        RowId FROM  TMCCostDetails Where  QuoteNo = @QuNo order by RowId asc ";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    cmd = new SqlCommand(strMCIM, EmetCon);
                    cmd.Parameters.AddWithValue("@QuNo", QuNo);
                ...
                strUnitData = @"select TotalMaterialCost,TotalProcessCost,TotalSubMaterialCost,TotalOtheritemsCost
                ,GrandTotalCost,Profit,Discount,FinalQuotePrice,CommentByVendor from TQuoteDetails  Where QuoteNo = @QuoteNo";
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    cmd = new SqlCommand(strUnitData, EmetCon);
                    cmd.Parameters.AddWithValue("@QuoteNo", QuNo);
        ...
        private void subMatCostDataStore()
        {
            try
            {
                if (Session["DtDynamicSubMaterialsFields"] != null)
                {
                    DataTable DtDynamicSubMaterialsFields = new DataTable();
                    DtDynamicSubMaterialsFields = (DataTable)Session["DtDynamicSubMaterialsFields"];
                    //hdnSMCTableValues.Value = "NaNCSHG30SPROCKETSTP,20000,1200000,0.016667,0.03333,NaNTEST,20000,1200000,0.016667,0.03333,IM100TO120T,12000,200000,0.060000,0.06000,";
                    var tempSublistcount = hdnSMCTableValues.Value.ToString().Split(',').ToList();
                ...
                {
                    LbMsgErr.Text = "Function subMatCostDataStore() > Session DtDynamicSubMaterialsFields is empty , Please Contact Administrator";
                }
            }
            catch (Exception ex)
            {
        ...
        protected void BtnFndVndRate_Click(object sender, EventArgs e)
        {
            ...
            //System.Web.UI.ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "ClientScript", "StoreVndRate(" + ColumnNo + ");", true);
        }
        ...
        protected void BtnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, Page.GetType(), "myModalSession", "$('#myModalSession').modal('hide');", true);
        ...
        protected void BtnUpload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ProcessCostDataStore();
                MCCostDataStore();
                Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "returnProfDiscGA();MatlCalculation();othercost();submatlcost(); RestoreDataTbaleUnit();AllRecalculate();ComntByVendorLght();", true);
            }
            catch (Exception ex)
            {
                LbMsgErr.Text = ex.StackTrace.ToString() + " - " + ex.Message.ToString(); DvMsgErr.Visible = true;
        ...
        protected void btnAddColumns_Click(object sender, EventArgs e)
        {
            ...
            System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "MCDataStore();freezeheader();", true);
            //FirstLoad = false;
            //CreateDynamicDT(0);
            //MtlAddCount++;
            //CreateDynamicDT(MtlAddCount);
        ...
        protected void BtnDelMaterial_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "MatlCalculation();freezeheader();", true);
            }
