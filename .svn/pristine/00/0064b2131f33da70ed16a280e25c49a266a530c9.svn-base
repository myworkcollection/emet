<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EPICEmail.aspx.cs" Inherits="Material_Evaluation.EPICEmail" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-fw fa-list"></i>PIC Email
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3" style="padding-bottom: 5px;">
                                                <asp:DropDownList runat="server" ID="DdlFilterBy">
                                                    ...
                                                    <asp:ListItem Text="Vendor Name" Value="Description"></asp:ListItem>
                                                    <asp:ListItem Text="Approver" Value="Approver"></asp:ListItem>
                                                    <asp:ListItem Text="Approver Email" Value="ApproverEmail"></asp:ListItem>
                                                    <asp:ListItem Text="PIC Name" Value="PICName"></asp:ListItem>
                                                    <asp:ListItem Text="PIC Email" Value="PICEmail"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-7">
                                                        ...
                                                        <ContentTemplate>
                                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Description" HeaderText="Vendor Name" SortExpression="Description"></asp:BoundField>
                                                                    <asp:BoundField DataField="Approver" HeaderText="Approver" SortExpression="Approver"></asp:BoundField>
                                                                    <asp:BoundField DataField="ApproverEmail" HeaderText="ApproverEmail" SortExpression="ApproverEmail"></asp:BoundField>
                                                                    <asp:BoundField DataField="PICName" HeaderText="PIC Name" SortExpression="PICName"></asp:BoundField>
                                                                    <asp:BoundField DataField="PICEmail" HeaderText="PIC Email" SortExpression="PICEmail"></asp:BoundField>
                                                                </Columns>
