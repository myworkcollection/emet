<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RevisionReq_Waitting.aspx.cs" Inherits="Material_Evaluation.RevisionReq_Waitting" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-chart-area"></i>TEAM SHIMANO S.E.A. QUOTATION STATUS - <b>Quote Request With SAP Code (Revision) </b>
                            </div>
                        </div>
                        <div class="card-body">
                                                ...
                                                <ContentTemplate>
                                                    <asp:GridView ID="GridView1" runat="server"
                                                        ...
                                                        <Columns>
                                                                    ...
                                                                    <asp:Panel ID="pnlDet" runat="server" Style="display: none">
                                                                        <asp:GridView ID="GvDet" runat="server" AutoGenerateColumns="false" CssClass="table-hover Padding-Nol"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="VendorCode1" HeaderText="Vendor"></asp:BoundField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Q.Res.Due Dt">
                                                                <ItemTemplate>
