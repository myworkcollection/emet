...
{
    public partial class VndMachineList : System.Web.UI.Page
    {
        string sql;
        SqlCommand cmd;
            ...
            try
            {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                        ...
                        string FN = "EMET_VendorMachineList";
        ...
        protected void ShowTable()
        {
            ...
            try
            {
                ...
                {
                    sql = @" select ProcessGrp,MachineID,MachineDescription,MachineType,Tonnage,TotalUnits,NoofUnitsforSMN,SMNStdrateHr
                              from TVENDORMACHNLIST where delflag=0 and plant = @plant and VendorCode=@VendorCode ";
                    if (txtFind.Text != "")
                    {
