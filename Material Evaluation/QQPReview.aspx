<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QQPReview.aspx.cs" Inherits="Material_Evaluation.QQPReview" %>
                            ...
                            <div class="col-md-12" style="background-color: white;">
                                ...
                                <div class="row" style="padding-bottom: 10px;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row" runat="server" id="DvImRcylRatio" visible="false">
                                            <div class="col-md-5">
                                                <asp:Label ID="Label42" runat="server" ForeColor="Black" Text="Recycle Ratio (%)"></asp:Label>
                                            </div>
                                            <div class="col-md-7">
                                ...
                                <div class="row" style="padding-bottom: 10px; display: block;">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-12" style="padding-bottom: 5px;">
                                                <div class="col-md-12 Padding-Nol" style="border-bottom: 1px solid blue">
                                                    <asp:Label ID="Label36" runat="server" ForeColor="#ff3300" Font-Bold="true" 
                                            ...
                                            <asp:GridView ID="GdvPrevQuote" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="false" BackColor="White"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="QuoteNo" HeaderStyle-CssClass="text-center ">
                                                        <ItemTemplate>
                                                            <asp:Label Text='<%# Eval("QuoteNo") %>' ItemStyle-Width="150px" runat="server" ID="LbQuoteNo" ForeColor="Blue"/>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                ...
                                <div id="DvProcessCostPart" style="display: block;">
                                    ...
                                    <div class="row" style="padding-bottom: 10px;">
                                        ...
                                        <div class="col-md-12" id="DvOldOldProccost" runat="server" visible="true">
                                ...
                                <div id="DvSubMatPart" style="display: block;">
                                    ...
                                    <div class="row" style="padding-bottom: 10px;">
                                        ...
                                        <div class="col-md-12" id="DvOldSubMat" runat="server" visible="true">
