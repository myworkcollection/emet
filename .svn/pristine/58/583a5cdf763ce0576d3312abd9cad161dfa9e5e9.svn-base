<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WithSApCode.aspx.cs" Inherits="Material_Evaluation.WithSApCode" %>
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <ul class="navbar-nav ml-auto ml-md-0">
       ...
       <%-- <li class="nav-item dropdown no-arrow">
		  ...
		  <ol class="breadcrumb">
            <li >
              <asp:Label ID="Label8"  runat="server" Width="147px"></asp:Label>
             <br/>
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <tr>
                        ...
                        <td >
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                              ...
                              <asp:TextBox ID="txtSAPProdID" runat="server" Height="30px" TextMode="MultiLine"  AutoPostBack="true"
                                      Width="250px" ontextchanged="txtSAPProdID_TextChanged"  ></asp:TextBox>
                              <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionInterval="1" CompletionListElementID="pnlPrdCode"
                                EnableCaching="true" FirstRowSelected="true" MinimumPrefixLength="1" ServiceMethod="getProduct"
                                TargetControlID="txtSAPProdID" UseContextKey="True">
                            </asp:AutoCompleteExtender> 
                                                  

                              </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="txtSAPProdID" />
                    </Triggers>
                </asp:UpdatePanel>
                    ...
                    <tr>
                        <td >
                            <asp:Label ID="Label3" runat="server" Text="SAP Part Code :" Font-Bold="True" 
                                ForeColor="Black"></asp:Label>
                        </td>
                        <td >
                         ...
                         <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            ...
                            <asp:TextBox ID="txtpartdesc" Enabled="false" runat="server"  Height="30px" AutoPostBack="true" TextMode="MultiLine" 
                    ...
                    <Triggers>
                        ...
                        <asp:Label ID="Label6" runat="server"  Text="Part Code Description :"
                                Width="160px" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                            ...
                            <asp:TextBox ID="txtpartdescription" runat="server" Enabled="false" Width="250px" Height="30px"  AutoPostBack="true"
                    ...
                    <Triggers>
                        ...
                        <td >
                             <asp:UpdatePanel ID="UpdatePanel111" runat="server">
                              <ContentTemplate>
                                        <asp:TextBox ID="txtunitweight" runat="server" Enabled="false" AutoPostBack="true" AutoCompleteType="Disabled" autocomplete="off" Height="30px" Width="70px"></asp:TextBox> 
                                         <asp:TextBox ID="txtUOM" runat="server" Enabled="false" AutoPostBack="true" AutoCompleteType="Disabled" autocomplete="off" Height="30px" Width="80px"></asp:TextBox> 
                                       </ContentTemplate>
                                        <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="txtpartdesc" />
                    </Triggers>
                    ...
                    <tr>
                        ...
                        <asp:ImageButton ID="Image3" runat="server" Height="50" Width="50" Visible="false" 
                                OnClientClick="DisplayNewImageInWidnow();" />
