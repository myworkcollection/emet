<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuoteCostPlan.aspx.cs"
    Inherits="Material_Evaluation.QuoteCostPlan" MaintainScrollPositionOnPostback="true" %>
    ...
    <script type="text/javascript">
        ...
        function CekValueInputByUser() {
            try {
                ...
                var TabBOM = document.getElementById("GridView1");
                var rowscountTabBOM = TabBOM.rows.length;
                    ...
                    if (Layout == "Layout1") {
                        if (rowscountTabBOM <= 1) {
                            for (var i = 1; i < rowscountTabMatCost; i++) {
                                ...
                                if (FieldName == "Material SAP Code" || FieldName == "Material Description" || FieldName == "Raw Material Cost/ kg" || FieldName == "Part Net Unit Weight (g)"
                                    || FieldName == "Runner Weight/shot (g)" || FieldName == "Recycle Material Ratio (%)" || FieldName == "Base Qty / Cavity" || FieldName == "Material/Melting Loss (%)") {
                                    ...
                                    if (tr != null) {
                                        for (var z = 1; z < CellsCountTabMatCost; z++) {
                                            ...
                                            //set all enabled text box doesnt care if have default or not to blue
                                            var td = tr.cells[z];
                                            if (td != null) {
                                                td.style.color = "blue";
                                            }
                                ...
                                if (FieldName == "Material SAP Code" || FieldName == "Material Description" || FieldName == "Raw Material Cost/ kg" || FieldName == "Part Net Unit Weight (g)"
                                    ...
                                    if (tr != null) {
                                        for (var z = 1; z < CellsCountTabMatCost; z++) {
                                            ...
                                            if (FieldName == "Material SAP Code" || FieldName == "Material Description" || FieldName == "Raw Material Cost/ kg") {
                        ...
                        if (rowscountTabBOM <= 1) {
                            for (var i = 1; i < rowscountTabMatCost; i++) {
                                var FieldName = TabMatCost.rows[i].cells[0].innerHTML.trim();
                                if (FieldName == "Material SAP Code" || FieldName == "Part Net Unit Weight (g)"
                        ...
                        if (rowscountTabBOM <= 1) {
                            for (var i = 1; i < rowscountTabMatCost; i++) {
                                var FieldName = TabMatCost.rows[i].cells[0].innerHTML.trim();
                                if (FieldName == "Material SAP Code" || FieldName == "Material Description" || FieldName == "Raw Material Cost/ kg" || FieldName == "Part Net Unit Weight (g)"
                                    || FieldName == "Thickness (mm)" || FieldName == "Width (mm)" || FieldName == "Pitch (mm)"
                    ...
                    <div class="card" style="background-color: white">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12" style="background-color: rgba(0,0,0,.03);">
                                ...
                                <div class="row" style="padding-bottom: 5px">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row" runat="server" id="DVSmnSubmit" visible="false">
                                            <div class="col-md-4">
                                                <asp:Label ID="Label38" runat="server" Text="Quote Submition By"></asp:Label>
                                            </div>
                                            <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="table-responsive table-sm">
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="false"
                                                        EmptyDataText="No records Found" BackColor="White" CssClass="table-responsive table-sm" Width="100%">
                                                        <Columns>
                                                            <asp:BoundField DataField="material" HeaderText="Material" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left" />
                                                            <asp:BoundField DataField="MaterialDesc" HeaderText="Material Desc" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left" />
                                ...
                                <!-- BOM DATA ang PIR old Quote Mass revision-->
                                <div class="row" style="padding-bottom: 10px;" runat="server" id="DvGvSMNBomMassRev" visible="false">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-12" style="padding-bottom: 5px;">
                                                <div class="col-md-12 Padding-Nol" style="border-bottom: 1px solid blue">
                                                    <asp:Label ID="Label36" runat="server" ForeColor="Black" Text="New SMN BOM & Material Cost details Based On Effective Date"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="table-responsive table-sm">
                                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="GvSMNBomMassRev" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
                                                                EmptyDataText="No records Found" BackColor="White" CssClass="table-responsive table-sm" Width="100%">
                                                                <Columns>
                                                                    <asp:BoundField DataField="material" HeaderText="Material" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left" />
                                                                    <asp:BoundField DataField="MaterialDesc" HeaderText="Material Desc" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left" />
                                        ...
                                        <div class="row" style="padding-top: 5px;">
                                            <div class="col-md-12" style="padding-bottom: 5px;">
                                                <div class="col-md-12 Padding-Nol" style="border-bottom: 1px solid blue">
                                                    <asp:Label ID="Label37" runat="server" ForeColor="Black" Text="Old Data From PIR"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="table-responsive table-sm">
                                ...
                                <div class="row" style="display: block;" id="DvPrevQuote">
                                    <div class="col-md-12">
                                        <div class="col-md-12 title">
                                            <asp:Label ID="Label9" runat="server" Text="Previous Approved Quotation"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 table table-responsive" style="padding: 0px; display: block;">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true"
                                        ...
                                        <ContentTemplate>
                                            <asp:GridView ID="GdvPrevQuote" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="false" BackColor="White"
                                                OnRowDataBound="GdvPrevQuote_RowDataBound" OnRowCommand="GdvPrevQuote_RowCommand" EmptyDataText="No records Found"
                                                CssClass="table-responsive  table-sm table-bordered table-nowrap  Padding-Nol WrapCnt" Width="100%">
                                                <Columns>
                                                    <asp:BoundField DataField="RequestDate" HeaderText="Req. Date" ItemStyle-Width="150px" SortExpression="RequestDate" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    <asp:BoundField DataField="RequestNumber" HeaderText="Request Number" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    <asp:TemplateField HeaderText="QuoteNo" HeaderStyle-CssClass="text-center ">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:BoundField DataField="TotalMaterialCost" HeaderText="Tot. Material Cost" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    <asp:BoundField DataField="TotalProcessCost" HeaderText="Tot. Process Cost" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    <asp:BoundField DataField="TotalSubMaterialCost" HeaderText="Tot. Sub Material Cost" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    <asp:BoundField DataField="TotalOtheritemsCost" HeaderText="Tot. Other items Cost" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    <asp:BoundField DataField="GrandTotalCost" HeaderText="Grand Total Cost" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    <asp:BoundField DataField="Profit" HeaderText="Profit %" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    <asp:BoundField DataField="Discount" HeaderText="Discount %" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    <asp:BoundField DataField="FinalQuotePrice" HeaderText="Final Quote Price" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="ApprovebyDIR" HeaderText="Approve by DIR" ItemStyle-HorizontalAlign="Left" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                    <asp:BoundField DataField="DIRApprovalDate" HeaderText="DIR Approval Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                </Columns>
                                                <FooterStyle BackColor="White" ForeColor="#000066" />
