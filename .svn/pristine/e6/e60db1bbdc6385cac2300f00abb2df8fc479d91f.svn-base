<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VWhitoutSAPCode.aspx.cs" Inherits="Material_Evaluation.VWhitoutSAPCode" %>
...
<head>
    ...
    <%--script open modal--%>
    <script type="text/javascript">
        function openInNewTab(url, Status) {
            if (Status == "SUBMITTED") {
                            ...
                            <div class="card-header-content ">
                                <div class="row">
                                    <div class="col-md-12" style="word-wrap: break-word; font-size: 18px;">
                                        <i class="fas fa-chart-area"></i>TEAM SHIMANO S.E.A. QUOTATION STATUS - <b>Quote Request Without SAP Code </b>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4" style="padding-bottom: 5px;">
                                                <asp:DropDownList runat="server" ID="DdltaskStatus" ToolTip="Task Status">
                                                    ...
                                                    <asp:ListItem Text="New & Draft" Value="New-Draft"></asp:ListItem>
                                                    <asp:ListItem Text="Submitted" Value="Submitted"></asp:ListItem>
                                                    <asp:ListItem Text="Expired" Value="Expired"></asp:ListItem>
                                                    <asp:ListItem Text="Submitted & Expired" Value="Submitted-Expired"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-lg-4" style="padding-bottom: 5px;">
                                                        ...
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Req. No" SortExpression="RequestNumber" HeaderStyle-CssClass="text-center ">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton Text='<%# Eval("RequestNumber") %>' runat="server" ID="LbReqNo" CommandName="LinktoRedirect"
