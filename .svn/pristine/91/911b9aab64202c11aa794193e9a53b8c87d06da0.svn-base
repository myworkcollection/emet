<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewRequest_do.aspx.cs" Inherits="Material_Evaluation.NewRequest_do" %>
    ...
    <form id="form1" runat="server">
      ...
      <ul class="sidebar navbar-nav">
         <li class="nav-item active">
          <a class="nav-link" href="Emet_author_V.aspx?num=15">
            ...
            <span>Home</span>
              ...
              <li class="nav-item active">
          <a class="nav-link" href="NewRequest_do.aspx">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span>Create DO</span>
          </a>
        </li>
                            ...
                            <table width="100%" border="0" style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: rgba(0,0,0,.03);">
                                <tr>
                                    <td colspan="4" align="right">
                                        <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="Login-button" Width="100px" Height="23px" OnClick="btnReset_Click" />
                                        <asp:Button ID="btnclose" runat="server" Text="Close" CssClass="Login-button" PostBackUrl="Home.aspx" Width="100px" Height="23px" />
                            ...
                            <td class="style5">
                                ...
                                Width="250px">
                                                ...
                                                <asp:TextBox ID="txtmatlclass" runat="server" Height="30px" TextMode="MultiLine" AutoPostBack="true"
                                                    Width="250px" OnTextChanged="txtmatlclass_TextChanged" Visible="False"></asp:TextBox>
                                                ...
                                                <asp:DropDownList ID="ddlmatdescriptionC" runat="server" AutoPostBack="true" Font-Bold="True" ForeColor="Black" OnSelectedIndexChanged="ddlmatdescriptionC_SelectedIndexChanged" Width="281px">
                                                </asp:DropDownList>
                        ...
                        <td class="style5">
                            <asp:TextBox ID="txtpartdescription" runat="server" AutoPostBack="true" Height="29px" TextMode="MultiLine" CssClass="tetxboxcolor"
                                ...
                                <tr>
                                    ...
                                    <asp:FileUpload ID="FileUpload1" ToolTip="" runat="server"   EnableViewState="true" Height="30px" Width="200px" />
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel171" runat="server">
                                            <ContentTemplate>
                                                <asp:Label ID="lblMessage" runat="server" Enabled="False" Font-Bold="True" ForeColor="Black" Text="lblMessage"></asp:Label>
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:PostBackTrigger ControlID="btnUpload" />
                                            </Triggers>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div style="overflow: auto; height: 500px;width: 83%; clip: rect(auto, auto, auto, auto);">
