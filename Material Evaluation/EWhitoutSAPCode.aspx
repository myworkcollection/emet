<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EWhitoutSAPCode.aspx.cs" Inherits="Material_Evaluation.EWhitoutSAPCode" %>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Panel ID="pnlDet" runat="server" Style="display: none">
                                                                    <asp:GridView ID="GvDet" runat="server" AutoGenerateColumns="false" CssClass="table-hover Padding-Nol table-bordered"
                                                                        OnRowCreated="GvDet_RowCreated" OnRowDataBound="GvlDet_RowDataBound" OnRowCommand="GvDet_RowCommand"
                                                                        DataKeyNames="QuoteNo">
                                                                        <Columns>
