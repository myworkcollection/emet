<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EMachineList.aspx.cs" Inherits="Material_Evaluation.EMachineList" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-fw fa-list"></i>Machine List
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3" style="padding-bottom: 5px;">
                                                <asp:DropDownList runat="server" ID="DdlFilterBy">
                                                    ...
                                                    <asp:ListItem Text="Machine ID" Value="MachineID"></asp:ListItem>
                                                    <asp:ListItem Text="Machine Description" Value="MachineDescription"></asp:ListItem>
                                                    <asp:ListItem Text="Machine Type" Value="MachineType"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-7">
                                                        ...
                                                        <ContentTemplate>
                                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="VendorCode" HeaderText="Vendor Code" SortExpression="VendorCode"></asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="MachineID" HeaderText="Machine ID" SortExpression="MachineID"></asp:BoundField>
                                                                    <asp:BoundField DataField="MachineDescription" HeaderText="Machine Description" SortExpression="MachineDescription"></asp:BoundField>
                                                                    <asp:BoundField DataField="MachineType" HeaderText="Machine Type" SortExpression="MachineType"></asp:BoundField>
                                                                    <asp:BoundField DataField="Tonnage" HeaderText="Tonnage" SortExpression="Tonnage"></asp:BoundField>
                                                                    <asp:BoundField DataField="TotalUnits" HeaderText="Total Units" SortExpression="TotalUnits"></asp:BoundField>
                                                                    <asp:BoundField DataField="NoofUnitsforSMN" HeaderText="Noof Units for SMN" SortExpression="NoofUnitsforSMN"></asp:BoundField>
                                                                    <asp:BoundField DataField="SMNStdrateHr" HeaderText="SMN Std Rate / Hr" SortExpression="SMNStdrateHr"></asp:BoundField>
                                                                </Columns>
