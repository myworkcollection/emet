<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CClosed.aspx.cs" Inherits="Material_Evaluation.CClosed" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            mainUrl = window.location.href.replace("CClosed.aspx", "");
            SetUpSideBar();
            DatePitcker();
            GenerateTableReport();
            playAudio();
                    ...
                    <div class="col-lg-12" style="padding: 5px;">
                        <div class="row">
                            ...
                            <div class="col-sm-2 fa-pull-right" style="background-color: #E9ECEF;">
                                ...
                                <asp:LinkButton runat="server" ID="BtnLogOut" OnClientClick="LogOut();return false" Text="Logout"></asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
