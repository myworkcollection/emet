<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manager_Status.aspx.cs" Inherits="Material_Evaluation.ManagerStatus" %>
                        ...
                        <div class="card-body" style="width: 100%; overflow: auto">
                            <div class="row" style="padding-bottom:10px;">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <asp:Label ID="lblRequest_view" runat="server" Font-Bold="true" Text="MANAGER APPROVAL "></asp:Label>
                                        </div>
