<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRejected.aspx.cs" Inherits="Material_Evaluation.CRejected" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-chart-area"></i>TEAM SHIMANO S.E.A. QUOTATION STATUS - <b>Rejected Request </b>
                            </div>
                        </div>
