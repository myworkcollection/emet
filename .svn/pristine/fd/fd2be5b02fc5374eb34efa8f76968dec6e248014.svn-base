<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VWhitoutSAPCodeGp.aspx.cs" Inherits="Material_Evaluation.VWhitoutSAPCodeGp" %>
                                                        ...
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Req. No" SortExpression="RequestNumber" HeaderStyle-CssClass="text-center ">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton Text='<%# Eval("RequestNumber") %>' runat="server" CommandName="LinktoRedirect" ID="LbReqNo"
