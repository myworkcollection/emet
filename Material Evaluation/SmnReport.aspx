<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SmnReport.aspx.cs" Inherits="Material_Evaluation.SmnReport" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            mainUrl = window.location.href.replace("SmnReport.aspx", "");
            SetUpSideBar();
            DatePitcker();
            GenerateTableReport();
        });
            ...
            if (typeof (Worker) !== "undefined") {
                try {
                    ...
                    dataTableReport = $("#TableReport").DataTable({
                        ...
                        { "data": "DIR_Decision", "autoWidth": true },
                        { "data": "DIR_Name", "autoWidth": true },
                        {
                            "data": "DIRAprRejDate",
                            "render": function (value) {
                                if (value === null) return "";
                    ...
                    setTimeout(function () {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                ExtraFilter: _ExtraFilter, VendorCode : ""
                            },
                            async: false,
                            beforeSend: function () {
                                ShowLoading();
                    ...
                    <div class="col-lg-12" style="padding: 5px;">
                        <div class="row">
                            ...
                            <div class="col-sm-2 fa-pull-right" style="background-color: #E9ECEF;">
                                ...
                                <asp:LinkButton runat="server" ID="BtnLogOut" Text="Logout" autopostback="false" OnClientClick="LogOut()"></asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <ContentTemplate>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10 text-right" style="padding-bottom: 5px;">
                                            ...
                                            <asp:Button runat="server" ID="BtnReset" Text="Reset" CssClass="btn btn-sm btn-warning" OnClientClick="BtnReset_Click()" AutoPostBack="false"></asp:Button>
                                    ...
                                    <div class="row" style="padding-bottom: 5px;">
                                        ...
                                        <div class="col-md-4">
                                            <asp:LinkButton ID="btnSearch" CssClass="btn btn-sm btn-info btn-block" runat="server"
                                                autopostback="false" OnClientClick="GetAllExtraFilterData();ShowLoading();GetReportData();"><i class="fa fa-search" aria-hidden="true"
