<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Review_req.aspx.cs" Inherits="Material_Evaluation.Review_req" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (QuoteRef != "" && (chkIsUseToolAmor.checked == true || chkIsUseMacAmor.checked == true)) {
                if (TxtSubMatcostTot != null) {
                    if (TxtSubMatcostTot.value == "0.00000") {
        ...
        $(document).on('keyup', '#txtProfit\\(\\%\\)0', function () {
            ...
            if (hdnVendorType == "TeamShimano") {
                ...
                document.getElementById("txtFinalQuotePrice/pcs1").value = fixedDecml(FinalVal, 5);

                var Finalresult = TotMatCostFn + FinalVal + TotSubMatCostFn + TotOthrCostFn
                document.getElementById("txtFinalQuotePrice/pcs4").value = fixedDecml(Finalresult, 5);
    ...
    <script type="text/javascript">
        ...
        function DelAttachment() {
            try {
                document.getElementById("DvOldFile").style.display = "none";
                document.getElementById("DvNewFile").style.display = "block";

                document.getElementById("FlAttachment").value = '';
                $('#LbFlName').text("No File");
                $('#TxtLbFlName').val("No File");
        ...
        function RestoreOldAtchmnt() {
            try {
                document.getElementById("DvOldFile").style.display = "block";
                document.getElementById("DvNewFile").style.display = "none";
                $('#LbFlName').text($('#LbOldFlName').text());
                $('#TxtLbFlName').val($('#LbOldFlName').text());
                document.getElementById("LbFlName").innerHTML = document.getElementById("LbOldFlName").innerHTML;
            } catch (err) {
                alert("RestoreOldAtchmnt() : " + err);
            }
        }
    </script>
                        ...
                        <div class="card-body" style="padding-top: 0px;">
                            ...
                            <div class="col-md-12" style="background-color: white;">
                                ...
                                <div class="row" style="padding-bottom: 10px;">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row" runat="server" id="DvReqPlant" style="display: none;">
                                            <div class="col-md-5">
                                                <asp:Label ID="Label32" runat="server" ForeColor="Black" Text="GP Request Plant"></asp:Label>
                                            </div>
                                            <div class="col-md-7">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="group-main">
                                                    <div class="SearchBox-txt">
                                                        <asp:TextBox ID="TextBox1" OnclientClick="return false;" Enabled="false"
                                                            onkeydown="javascript:preventInput(event);"
                                                            autocomplete="off" AutoCompleteType="Disabled"
                                                            runat="server" ForeColor="Black" CssClass="form_datetime">
                                                        </asp:TextBox>
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="group-main">
                                                    <div class="SearchBox-txt">
                                                        <asp:TextBox ID="txtfinal" OnclientClick="return false;" runat="server" CssClass="form_datetime"
                                            ...
                                            <div class="col-lg-7">
                                                <asp:UpdatePanel ID="UpdatePanel22" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        ...
                                                        <div id="DvOldFile" runat="server" class="lbattachpad pull-right nopadding" style="display:block">
                                                            <a href="#" id="myOldFilelink" runat="server" style="padding:0px;" target="_blank" download>
                                                                <span class="glyphicon glyphicon-download" style="padding: 0px; color: #0bd409;" runat="server" id="Span4"></span>
                                                            </a>
                                                        </div>

                                                        <div id="DvNewFile" runat="server" class="lbattachpad pull-right nopadding" style="display:block">
                                                        ...
                                                        <div style="display: none">
                                                            <asp:LinkButton runat="server" ID="LbRefresh" OnClientClick="RestoreOldAtchmnt();return false;"
                                                            CssClass="lbattachpad pull-right">
                                                            ...
                                                            <asp:TextBox ID="TxtOriginalFilePath" runat="server" ForeColor="Black" Text="No File"></asp:TextBox>
                                                            <asp:TextBox ID="TxtLbFlName" runat="server" ForeColor="Black" Text="No File"></asp:TextBox>

                                                            <asp:Label ID="LbFlNameOri" runat="server" ForeColor="Black" Text="No File"></asp:Label>
                                                            <asp:Label ID="LbOldFlName" runat="server" ForeColor="Black" Text="No File"></asp:Label>
                                ...
                                <div id="DvProcessCostPart" style="display: block;">
                                    ...
                                    <div class="row" style="padding-bottom: 10px;">
                                        <div class="col-md-12">
                                            <asp:Button ID="Button6" runat="server" Text="Calculate Process Cost" 
                                                OnClientClick="if(ValidateProcCost()==false) return false;processcost();
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:Button ID="btnAddSubProcessCost" runat="server" Text="Add SUB-MAT Cost" Width="250px"
                                                        CssClass="btn btn-success" OnClientClick="if(CekMachineAmortizeFromProcCostTable2(false) == false) return false;"  OnClick="btnAddSubProcessCost_Click" />
                                                    <div style="display:none">
                                    ...
                                    <div class="row" style="padding-bottom: 10px;">
                                        <div class="col-md-12">
                                            <asp:Button ID="Button4" runat="server" Text="Calculate Sub Material Cost"
                                                OnClientClick="if(ValidateSubMat()==false) return false;if(CekMachineAmortizeFromProcCostTable(false) == false) return false;return false;" UseSubmitBehavior="false" Width="250px"
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel11" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:Button ID="BtnSaveDraft" runat="server" Text="Save As Draft"
                                                    CssClass="btn btn-primary" OnClick="BtnSaveDraft_Click" OnClientClick="ReCalculate();AllRecalculate();ShowLoading();" />
                                                <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="btn btn-primary"
                                                    OnClientClick="if(cekIsHaveOldToolOrmachineAmortize(false) == false) return false;if(validateTotalValue()==false) return false;if(ValidateMatCalc()==false) return false;MatlCalculation();if(ValidateProcCost()==false) return false;processcost();if(ValidateSubMat()==false) return false;submatlcost();if(ValidateOthCost()==false) return false;othercost();if(ValidateUnit()==false) return false;ReCalculate();AllRecalculate();ShowLoading();" OnClick="Button1_Click1" />
