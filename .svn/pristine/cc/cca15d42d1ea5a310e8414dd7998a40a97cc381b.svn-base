<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EProcGrpVsSubProc.aspx.cs" Inherits="Material_Evaluation.EProcGrpVsSubProc" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-fw fa-list"></i>Process Group Vs Sub process
