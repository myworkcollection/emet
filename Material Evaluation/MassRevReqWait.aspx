<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MassRevReqWait.aspx.cs" Inherits="Material_Evaluation.MassRevReqWait" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-chart-area"></i>TEAM SHIMANO S.E.A. QUOTATION STATUS - <b>Quote Request With SAP Code (Mass Revision)</b>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <asp:Panel runat="server" DefaultButton="btnSearch">
                                        <div class="row">
                                            <div class="col-lg-4" style="padding-bottom: 5px;">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <asp:Label runat="server" ID="Label3" Text="Task Status"></asp:Label>
                                                    </div>
                                                    <div class="col-md-6">
                                ...
                                <ContentTemplate>
                                    <div class="row" style="padding-top: 10px; padding-bottom: 10px;">
                                        ...
                                        <div class="col-sm-6 ">
                                            ...
                                            <asp:TextBox runat="server" ID="TxtShowEntry" Text="10" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" AutoPostBack="true"
                                                Width="50px" CssClass="fa-pull-right" Style="text-align: center" onchange="ShowLoading();" OnTextChanged="TxtShowEntry_TextChanged"></asp:TextBox>
                                    ...
                                    <div class="col-lg-12 table table-responsive" style="padding: 0px;">
                                        <asp:updateprogress id="updProgress" xmlns:asp="#unknown" associatedupdatepanelid="UpdatePanel1" runat="server">
                                                    <progresstemplate>            
                                                        <div class="row">
                                                                <div id="loading2" class="col-sm-12" style="padding-top:200px;" >
                                                                    <img id="loading-image2" src="images/loading.gif" alt="Loading..."/>
                                                                    <div class="col-sm-12" style="text-align:center; opacity:1;">
                                                                        <asp:label ID="lbpleasewait" runat="server" Text="please Wait..." Font-Bold="true" ForeColor="#0000ff"></asp:label>
                                                                    </div>
                                                                </div>
                                                        </div>          
                                                    </progresstemplate>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true"
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="GridView1" runat="server" onclientclick="alert('a')"
                                                                    ...
                                                                    <asp:GridView ID="GvDet" runat="server" AutoGenerateColumns="false" CssClass="table-hover Padding-Nol"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Quote No" HeaderStyle-CssClass="text-center ">
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton Text='<%# Eval("QuoteNo") %>' runat="server"
                                                                                        CommandName="LinktoRedirect" CommandArgument='<%#Eval("ParentGvRowNo") +"|"+ ((GridViewRow) Container).RowIndex %>' OnClientClick="ShowLoading();" />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="TaskStatus" HeaderText="Task Status" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                                                        </Columns>
