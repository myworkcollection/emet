<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealTimeVendInv.aspx.cs" Inherits="Material_Evaluation.RealTimeVendInv" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectRow(row) {
            selectedRow = "";
            $("#hiddenSelectedRow").val("");
            var rowData = row.parentNode.parentNode;
            var rowIndex = rowData.rowIndex;
            selectedRow = rowIndex;
            $("#hiddenSelectedRow").val(selectedRow);
        }

        function UpdateRowIntable(Stock, Remark, updatedBy) {
            try {
                jQuery.noConflict();
                var today = new Date();
                ...
                //today = dd + '/' + mm + '/' + yyyy;
                dataTable.cell({ row: selectedRow, column: 10 }).data(Stock).draw();
                dataTable.cell({ row: selectedRow, column: 11 }).data(Remark).draw();
                dataTable.cell({ row: selectedRow, column: 18 }).data(updatedBy).draw();
                dataTable.cell({ row: selectedRow, column: 19 }).data(today).draw();
                //document.getElementById('TbData').rows[selectedRow].cells[10].innerHTML = Stock;
                //document.getElementById('TbData').rows[selectedRow].cells[11].innerHTML = Remark;
                //document.getElementById('TbData').rows[selectedRow].cells[15].innerHTML = today;
                //document.getElementById('TbData').rows[selectedRow].cells[16].innerHTML = updatedBy;
            }
            catch (err) {
                alert(err + ' : UpdateRowIntable');
            }
        }
        ...
        $(document).on('keypress', '#TxtStock', function (e) {
            if (((event.which != 46 || (event.which == 46 && $(this).val() == ''))) && (event.which < 48 || event.which > 57)) {
                event.preventDefault();
            }
            if (event.which == 46) {
        ...
        $(document).on('input', '#TxtStock', function (e) {
            var value = $(this).val();
            var numbers = value.replace(/[^0-9]/g, "");
            $(this).val(numbers);
        });
        ...
        function checkExtension() {
            ...
            if (extension.toUpperCase() == "XLS" || extension.toUpperCase() == "XLSX") {
                ...
                $("#FileUpload").val("");
                alert("Format File Only XLS or XLSX");
                return false;
            }
        }
    ...
    <script type="text/javascript">
        ...
        function openModalImportSummary() {
            try {
                jQuery.noConflict();
                $('#modalImportFailed').modal('show');
            }
            catch (err) {
                alert(err + ' : OpenModalSession');
            }
    ...
    <script type="text/javascript">
        ...
        function GenerateNewMainTable() {
            try {
                ...
                debugger
                var Mydata = [];
                if ($("#TxtDataMainJson") != null && $("#TxtDataMainJson").val() !== undefined) {
                    ...
                    window.setTimeout(function () {
                        dataTableMainData.columns.adjust().draw();
                    }, 500);
        ...
        function GenerateTbData() {
            try {
                ...
                dataTable = $("#TbData").DataTable({
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            if (data == "false") {
                                return '<button class="btn Table-button edit" style="margin-right: 3px; width:70px;"> Edit </button>';
                            } else {
                                return '<button class="btn Table-button" style="margin-right: 3px; width:70px;" disabled> Edit </button>';
                            }
                        },
                    ...
                    columnDefs: [
                            ...
                            { "searchable": false, "targets": [19, 20, 21] }
                    ],
                    scrollX: true,
                    scrollY: 430,
                    scrollCollapse: true,
                ...
                $('#TbData').on('click', '.edit', function () {
                    var data = dataTable.row($(this).parents('tr')).data();
                    selectedRow = dataTable.row($(this).parents('tr')).index();
                    currentPage = dataTable.page.info().page;

                    document.getElementById("hiddenPlant").value = data.Plant;
                    document.getElementById("hiddenVendorCode").value = data.VendorCode;
                    document.getElementById("hiddenSAPCode").value = data.SAPCode;
                    document.getElementById("hiddenCreatedDate").value = data.CreatedDate;
                    document.getElementById('btnEditAction').click();
                });

                var Mydata = [];
                if ($("#TxtDataJson") != null && $("#TxtDataJson").val() !== undefined) {
                    var test = $("#TxtDataJson").val();
                    if ($("#TxtDataJson").val() != "") {
        ...
        function disabledButtonEdit() {
            $("#TbData button.edit").prop("disabled", true);
        }
    </script>
</head>
<body id="page-top">
    <form id="form1" runat="server">
                                    ...
                                    <ContentTemplate>
                                        <div class="row">
                                            <div class="col-lg-8" style="padding-bottom: 5px;">
                                                <asp:Label runat="server" ID="Label17" Text="Filter By :"></asp:Label>
                                            </div>
                                            <div class="col-sm-4 text-right" style="padding-bottom: 5px;">
                                                <asp:Button ID="btnExport" runat="server" Text="Export" CssClass="btn btn-sm btn-primary" OnClientClick="exportTable();" />
                                                ...
                                                <asp:Button ID="Button7" runat="server" Text="Back to Main Page" CssClass="btn btn-sm btn-danger" OnClientClick="showMainPage();" />
                                            </div>
                                        </div>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                                        ...
                                        <asp:Panel runat="server" DefaultButton="btnSearch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4" style="padding-bottom: 5px;">
                                                    <div class="group-main">
                                                        <div class="SearchBox-txt">
                                                            <asp:TextBox ID="TxtFrom" OnclientClick="return false;" runat="server" placeholder="Date From" OnTextChanged="TxtFrom_TextChanged"
                                                ...
                                                <div class="col-lg-4" style="padding-bottom: 5px;">
                                                    <div class="group-main">
                                                        <div class="SearchBox-txt">
                                                            <asp:TextBox ID="TxtTo" OnclientClick="return false;" runat="server" placeholder="Date To" OnTextChanged="TxtTo_TextChanged"
                                                ...
                                                <ContentTemplate>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 text-right" style="padding-bottom: 5px;">
                                                            <asp:Label runat="server" ID="Label16" Text="Format Template :"></asp:Label>
                                                            <asp:RadioButton ID="rbActiveMaterial" runat="server" Text="Only Active Materials" GroupName="TemplateImport" Checked="true" CssClass="mr-5" />
                                                            <asp:RadioButton ID="rbAllMaterial" runat="server" Text="All materials" GroupName="TemplateImport" CssClass="mr-5" />
                                                <asp:Button ID="Button2" runat="server" Text="Show Detail" CssClass="btn btn-sm btn-success" OnClick="btnShowDetail_Click" OnClientClick="if(checkSelectedData()==false) return false;"/>
                                                            <asp:Button ID="btnTemplate" runat="server" Text="Template" CssClass="btn btn-sm btn-primary" OnClientClick="document.getElementById('BtnDownLOadtemplate').click();" />
                                                            <asp:Button ID="btnUpload" runat="server" Text="Upload" CssClass="btn btn-sm btn-success" OnClick="btnUpload_Click" />
                                                ...
                                                <table id="TbData" class="table table-bordered nowrap Padding-Nol WrapCnt" style="width: 100%; background-color: #006699;">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="padding: 5px;">Material Desc</th>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="GridView1" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="UOM" HeaderText="UOM" SortExpression="UOM" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="UpdatedDate" HeaderText="Updated Date" SortExpression="UpdatedDate" HeaderStyle-CssClass="text-center headerSorting" DataFormatString="{0: dd/MM/yyyy }"></asp:BoundField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" HeaderStyle-CssClass="text-center ">
                                                            <ItemTemplate>
                                                                <asp:Button ID="btnEdit" Text="Edit" runat="server" CssClass="btn Table-button" CommandName="gEdit" OnClientClick="selectRow(this);" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                        ...
                                        <div class="row" style="padding-bottom: 0px;">
                                            <div class="col-sm-12" style="padding-bottom: 0px;">
                                                ...
                                                <div class="row" style="padding-bottom: 5px;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <asp:TextBox ID="TxtvendorName" runat="server" Enabled="false"></asp:TextBox>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="padding-bottom: 5px;">
                                                    <div class="col-sm-4">
                                                        <asp:Label ID="Label14" runat="server" Text="PIR No"></asp:Label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <asp:TextBox ID="txtPirNo" runat="server" Enabled="false"></asp:TextBox>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="padding-bottom: 5px;">
                                                    <div class="col-sm-4">
                                                        <asp:Label ID="Label2" runat="server" Text="Customer Description"></asp:Label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <asp:TextBox ID="txtCustomerDesc" runat="server" Enabled="false"></asp:TextBox>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="padding-bottom: 5px; display: none;">
                                                    <div class="col-sm-4">
                                                        <asp:Label ID="Label15" runat="server" Text="Created Date"></asp:Label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <asp:TextBox ID="TxtCreatedDate" runat="server" Enabled="true"></asp:TextBox>
                                                    </div>
                                                </div>
        ...
        <%--modal File Import--%>
        <div class="modal fade" id="modalImportFile" data-backdrop="static" tabindex="-1" role="dialog"
            aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content" style="background: linear-gradient(90deg, #F7F7F7, #ffffff, #F7F7F7); border-radius: 15px;">
                    <div class="modal-header">
                        <div class="row">
                            <div class="col-sm-12 text-uppercase text-center" style="text-shadow: 1px 2px 1px white;">
                                <asp:Label ID="Label12" runat="server" Text="Import Data Real Time Inventory"
                                    ForeColor="#004080" Font-Bold="true" Font-Size="X-Large"></asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="modal-body" style="background-color: white; padding-bottom: 0px;">
                        <div class="row" style="padding-bottom: 0px;">
                            <div class="col-sm-12" style="padding-bottom: 0px;">
                                <asp:FileUpload ID="FileUpload" runat="server" onchange="if(checkExtension()==false) return false;" />
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer" style="background-color: #F5F5F5; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px; border-top: 0px;">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-6" style="padding-bottom: 8px;">
                                        <asp:Button ID="btnImportFile" CssClass="btn btn-sm btn-primary" OnClientClick="ShowLoading();" OnClick="btnImportFile_Click" Width="100%"
                                            Font-Size="14px" runat="server" Text="Import" />
                                    </div>
                                    <div class="col-sm-6 " style="padding-bottom: 8px;">
                                        <asp:Button ID="Button3" runat="server" CssClass="btn btn-sm btn-default" Text="Close" Width="100%"
                                            Font-Size="14px" data-dismiss="modal" aria-hidden="true" />
                                    </div>
                                </div>
                            </div>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="modal fade" id="modalImportFailed" data-backdrop="static" tabindex="-1" role="dialog"
                    aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <ContentTemplate>
                                <div class="modal-content" style="background: linear-gradient(90deg, #F7F7F7, #ffffff, #F7F7F7); border-radius: 15px; max-width: 100%;">
                                    <div class="modal-header">
                                        <div class="row">
                                            <div class="col-sm-12 text-uppercase text-center" style="text-shadow: 1px 2px 1px white;">
                                                <asp:Label ID="Label13" runat="server" Text="Import Summary"
                                                    ForeColor="#004080" Font-Bold="true" Font-Size="X-Large"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12" style="padding-bottom: 0px;">
                                                <div class="row" style="padding-bottom: 10px" runat="server" id="Div1">
                                                    <div class="col-md-12" style="padding-bottom: 15px;">
                                                        <div class="row">
                                                            <div class="col-sm-12 text-uppercase text-right" style="text-shadow: 1px 2px 1px white;">
                                                                <asp:Label ID="lblValidCount" runat="server" Text="Total Success Import : []"
                                                                    Font-Bold="true"></asp:Label>
                                                                <asp:Label ID="lblInvalidCount" runat="server" Text="Total Invalid Import : []"
                                                                    Font-Bold="true"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-12 text-uppercase text-right" style="text-shadow: 1px 2px 1px white;">
                                                                <asp:Button ID="btnExportInvalid" runat="server" Text="Export" CssClass="btn btn-sm btn-primary" OnClientClick="document.getElementById('BtnDownloadInvalidData').click();" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="table table-responsive table-sm">
                                                            <asp:GridView ID="GDVImportSummary" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="VndName" HeaderText="VndName" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="MaterialType" HeaderText="MaterialType" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="Material" HeaderText="Material" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="MaterialDesc" HeaderText="MaterialDesc" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="BaseUOM" HeaderText="BaseUOM" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="PIRNo" HeaderText="PIRno" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="Stock" HeaderText="Stock" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="Remark" HeaderText="Remark" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="PirDelFlag" HeaderText="PirDelFlag" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="PlantStatus" HeaderText="PlantStatus" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="CustomerNo" HeaderText="CustomerNo" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="Customerdescription" HeaderText="Customerdescription" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                    <asp:BoundField DataField="Issue Remark" HeaderText="Issue Remark" HeaderStyle-CssClass="text-center "></asp:BoundField>
                                                                </Columns>
                                                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                                                <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
                                                                <PagerSettings PageButtonCount="10" />
        ...
        <div style="display: none">
            <asp:LinkButton runat="server" ID="BtnDownLOadtemplate" CssClass="btn btn-sm btn-success btn-sm" Font-Size="14px"
                autopostback="true" OnClick="BtnDownLOadtemplate_Click"><i class="glyphicon glyphicon-export"></i> Export </asp:LinkButton>
            <asp:LinkButton runat="server" ID="BtnDownloadInvalidData" CssClass="btn btn-sm btn-success btn-sm" Font-Size="14px"
                autopostback="true" OnClick="BtnDownloadInvalidData_Click"><i class="glyphicon glyphicon-export"></i> Export </asp:LinkButton>
        </div>
        ...
        <div style="display: none">
            ...
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                <ContentTemplate>
                    <asp:LinkButton runat="server" ID="btnEditAction" CssClass="btn btn-sm btn-success btn-sm" Font-Size="14px"
                        autopostback="true" OnClick="btnEditAction_Click"> Edit </asp:LinkButton>
                </ContentTemplate>
            </asp:UpdatePanel>
            <asp:TextBox ID="hiddenCreatedDate" runat="server"></asp:TextBox>
            <asp:TextBox ID="hiddenPlant" runat="server"></asp:TextBox>
            <asp:TextBox ID="hiddenVendorCode" runat="server"></asp:TextBox>
            <asp:TextBox ID="hiddenCustomerCode" runat="server"></asp:TextBox>
            <asp:TextBox ID="hiddenSAPCode" runat="server"></asp:TextBox>
