<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vapproved.aspx.cs" Inherits="Material_Evaluation.Vapproved" %>
            ...
            <div id="SideBarMenu" style="width: 300px;" runat="server" class="SideBarMenu">
                <ul class="sidebar">
                    ...
                    <li class="sideMenu" runat="server" id="LiUnReadAnn" style="display:block">
                        ...
                        <audio id="myAlertAudio" controls="controls" style="display:none">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-chart-area"></i>TEAM SHIMANO S.E.A. QUOTATION STATUS - <b>Approved Request </b>
                            </div>
                        </div>
                        <div class="card-body">
