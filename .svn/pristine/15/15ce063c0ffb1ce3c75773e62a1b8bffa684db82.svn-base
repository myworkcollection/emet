...
{
    public partial class VWhitoutSAPCode : System.Web.UI.Page
    {
        string sql;
        SqlCommand cmd;
            ...
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    Where ( A.vendorcode1 = '" + mappeduserid.ToString() + @"' 
                            ...
                            and (SELECT RIGHT(A.QuoteNo, 1)) = 'D' 
                        ...
                        using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                        {
                            ...
                            else
                            {
                                ...
                                else if (isDraft.ToUpper() == "SUBMITTED")
                                {
                                    ...
                                    //ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "ClientScript", "openInNewTab('"+ url + "');CloseLoading();", true);
                                }
