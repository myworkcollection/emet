<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewReq_changesMass.aspx.cs" Inherits="Material_Evaluation.NewReq_changesMass" %>
...
<head>
                    ...
                    if (varhdnQuoteNoRef.toString() != "") {
                        if (matCostTbale != null) {
                            ...
                            for (var i = 1; i < CellsCount; i++) {
                                document.getElementById("txtMaterialCost/pcs" + (i - 1)).value = "";
                                document.getElementById("txtTotalMaterialCost/pcs0").value = "";
                            }
                        }
                    }
    ...
    <script type="text/javascript">
        ...
        function PrcGrpVsStokes_Min(ColumTblProcNo, Stk_Min, efficiency) {
            ...
            $('#txtDurationperProcessUOM\\(Sec\\)' + ColumTblProcNo).val(parseFloat(DurProcUom).toFixed(5));
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <asp:UpdatePanel ID="UpdatePanel22" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:LinkButton runat="server" ID="LbAttach" OnClientClick="AllRecalculate();ClcBtnFlUpload();return false;" CssClass="lbattachpad">
                                                        ...
                                                        <div style="display: none">
                                                            ...
                                                            <asp:Button runat="server" ID="BtnUpload" Text="upload" OnClientClick="return CheckFileSize();" OnClick="BtnUpload_Click" />
                                                        </div>
                                    ...
                                    <div class="row" style="padding-bottom: 10px;">
                                        <div class="col-md-12">
                                            <asp:Button ID="Button4" runat="server" Text="Calculate Sub Material Cost"
                                                OnClientClick="if(ValidateSubMat()==false) return false;submatlcost();return false" UseSubmitBehavior="false"
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel11" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:Button ID="BtnSaveDraft" runat="server" Text="Save As Draft"
                                                    CssClass="btn btn-primary" OnClick="BtnSaveDraft_Click" OnClientClick="if(ValidateMatCalc()==false) return false;if(validateTotalValue()==false) return false;ReCalculate();SaveAsDraftData();ShowLoading();" />
