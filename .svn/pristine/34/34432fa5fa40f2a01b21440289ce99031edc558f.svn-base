<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogPwdChange.aspx.cs" Inherits="Material_Evaluation.LogPwdChange" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-chart-area"></i>Log Vendor Password Changes
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4" style="padding-bottom: 5px;">
                                                <asp:DropDownList runat="server" ID="DdlFilterBy">
                                                    <asp:ListItem Text="Use ID" Value="UseID"></asp:ListItem>
                                                    <asp:ListItem Text="User Name" Value="UseNam"></asp:ListItem>
                                                    <asp:ListItem Text="Vendor Code" Value="VendorCode"></asp:ListItem>
                                                    <asp:ListItem Text="Vendor Desc" Value="VendorDesc"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true"
                                                ...
                                                <ContentTemplate>
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                        AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging" AllowSorting="True" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="UseID" HeaderText="Use ID" SortExpression="UseID"></asp:BoundField>
                                                            <asp:BoundField DataField="UseNam" HeaderText="User Name" SortExpression="UseNam"></asp:BoundField>
                                                            <asp:BoundField DataField="VendorCode" HeaderText="Vendor Code" SortExpression="VendorCode"></asp:BoundField>
                                                            <asp:BoundField DataField="Description" HeaderText="Vendor Desc" SortExpression="Description"></asp:BoundField>
                                                            <asp:BoundField DataField="UpdateBy" HeaderText="Updated By" SortExpression="UpdateBy"></asp:BoundField>
                                                            <%--<asp:BoundField DataField="UpdateAt" HeaderText="Updated At"></asp:BoundField>--%>
