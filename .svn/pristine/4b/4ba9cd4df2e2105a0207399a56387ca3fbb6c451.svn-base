<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcGrpVsSubProc.aspx.cs" Inherits="Material_Evaluation.ProcGrpVsSubProc" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-fw fa-list"></i><asp:Label runat="server" ID="LbVendorName"></asp:Label> : <b>Process Group Vs Sub process</b>
                        <asp:Button ID="btnclose" runat="server" Text="Close" CssClass="btn btn-sm btn-danger pull-right" OnClientClick="window.close();" />
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3" style="padding-bottom: 5px;">
                                                <asp:DropDownList runat="server" ID="DdlFilterBy">
                                                    <asp:ListItem Text="Process Group Code" Value="ProcessGrpCode"></asp:ListItem>
                                                    <asp:ListItem Text="Process Group Desc" Value="ProcessGrpDescription"></asp:ListItem>
                                                    <asp:ListItem Text="Sub Process Code" Value="SubProcessCode"></asp:ListItem>
                                                    <asp:ListItem Text="Sub Process Desc" Value="SubProcessName"></asp:ListItem>
                                                    <asp:ListItem Text="Process UOM" Value="ProcessUOM"></asp:ListItem>
                                                    <asp:ListItem Text="Process Uom Description" Value="ProcessUomDescription"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-7">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional" RenderMode="Block">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                                AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" AllowSorting="True" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="ProcessGrpCode" HeaderText="Process Group Code" SortExpression="ProcessGrpCode"></asp:BoundField>
                                                                    <asp:BoundField DataField="ProcessGrpDescription" HeaderText="Process Group Desc" SortExpression="ProcessGrpDescription"></asp:BoundField>
                                                                    <asp:BoundField DataField="SubProcessCode" HeaderText="Sub Process Code" SortExpression="SubProcessCode"></asp:BoundField>
                                                                    <asp:BoundField DataField="SubProcessName" HeaderText="Sub Process Desc" SortExpression="SubProcessName"></asp:BoundField>
                                                                    <asp:BoundField DataField="ProcessUOM" HeaderText="Process UOM" SortExpression="ProcessUOM"></asp:BoundField>
                                                                    <asp:BoundField DataField="ProcessUomDescription" HeaderText="Process Uom Description" SortExpression="ProcessUomDescription"></asp:BoundField>
                                                                </Columns>
