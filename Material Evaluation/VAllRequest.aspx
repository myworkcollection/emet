<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VAllRequest.aspx.cs" Inherits="Material_Evaluation.VAllRequest" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            mainUrl = window.location.href.replace("VAllRequest.aspx", "");
            SetUpSideBar();
            DatePitcker();
            SetUpSmnResponseDdl();
            GenerateTableReport();
            ...
            $($('#TbMainAllReq').DataTable().table().header()).on('click', 'tr:eq(0) th', function () {
                var totalPage = dataTable.page.info().pages;
                debugger;
                if ((currentPage + 1) <= totalPage) {
                    ...
                    if (currentPage != "") {
                        dataTable.page(totalPage - 1).draw('page');
                    }
                }
        ...
        function LoadDataDetail(RequestNumber) {
            try {
                ...
                for (var r = 0; r < data_filter.length; r++) {
                    ...
                    var MDecision = data_filter[r].MDecision === null ? '' : data_filter[r].MDecision;
                    var MAprRejDt = data_filter[r].MAprRejDt === null ? '' : moment(data_filter[r].MAprRejDt).format('DD-MM-YYYY');
                    var Mname = data_filter[r].Mname === null ? '' : data_filter[r].Mname;
                    var MComment = data_filter[r].MComment === null ? '' : data_filter[r].MComment;
                    ...
                    var url = "VViewRequest.aspx?Number=" + QuoteNo;
                    htmltext += '<tr>' +
                                    '<td>'+ (r+1) +'</td>' +
                                    '<td>' + VendorCode + '</td>' +
                                    '<td>' + VendorName + '</td>' +
    ...
    <script type="text/javascript">
        function GetReportData() {
            try {
                ...
                if (typeof (Worker) !== "undefined") {
                    setTimeout(function () {
                        var url = mainUrl + "/EmetServices/AllRequest/MyJson.asmx/LoadData";
                        ...
                        var _vendorCode = document.getElementById('TxtVendorCode').value;
                        $.ajax({
                            url: url,
                            cache: false,
                            type: "POST",
                            ...
                            data: {
                                ...
                                FltrDate: _FltrDate, From: _From, To: _To, FilterBy: _FilterBy, FilterValue: _FilterValue, VendorCode: _vendorCode
                            },
                            async: false,
                            beforeSend: function () {
                                ShowLoading();
        ...
        function SetupObjectToExportMain(MainData) {
            try {
                ...
                for (var r = 0; r < MainData.length; r++) {
                    ...
                    var ReqSts = MainData[r].ReqSts === null ? '' : MainData[r].ReqSts;
        ...
        function SetupObjectToExportDet(DataDet) {
            try {
                ...
                for (var r = 0; r < DataDet.length; r++) {
                    ...
                    var ReqSts = DataDet[r].ReqSts === null ? '' : DataDet[r].ReqSts;
                    ...
                    var MDecision = DataDet[r].MDecision === null ? '' : DataDet[r].MDecision;
                    var MAprRejDt = DataDet[r].MAprRejDt === null ? '' : moment(DataDet[r].MAprRejDt).format('DD-MM-YYYY');
                    var Mname = DataDet[r].Mname === null ? '' : DataDet[r].Mname;
                    var MComment = DataDet[r].MComment === null ? '' : DataDet[r].MComment;
                    ...
                    SetUpObjToExportDet.push(
                        ...
                        , TotalOtheritemsCost, GrandTotalCost, FinalQuotePrice, ResponseStatus, MDecision, MAprRejDt, Mname, MComment, DDecision, DAprRejDt, Dname, DComment
                    )
                    ...
                    var data = [
                        {
                            ...
                            "title": ["Report Name: e-MET All Request Main Data", "Report Generated: " + today + " "],
            ...
            try {
                if (NewObjToExportDetails.length > 0) {
                    ...
                    var data = [
                        {
                            "styles": { title: 17, messageTop: 0, messageBottom: 0, header: 22, footer: 0 },
                            "title": ["Report Name: e-MET All Request [Main & Details] ", "Report Generated: " + today + " "],
                            "messageTop": null, "messageBottom": null,
                            "header": MyHeader,
...
<body id="page-top">
    <form id="form1" runat="server" autopostback="false">
                    ...
                    <div class="col-lg-12" style="padding: 5px;">
                        <div class="row">
                            <div class="col-sm-10" style="padding-top: 5px;">
                                ...
                                <asp:LinkButton runat="server" OnClientClick="SidebarMenu();" class="btn btn-link btn-sm text-white order-1 order-sm-0" ID="sidebarToggle" autopostback="false"><i class="fas fa-bars"></i> </asp:LinkButton>
                            ...
                            <div class="col-sm-2 fa-pull-right" style="background-color: #E9ECEF;">
                                ...
                                <asp:LinkButton runat="server" ID="BtnLogOut" OnClientClick="LogOut();return false" autopostback="false" Text="Logout"></asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-content ">
                                <i class="fas fa-chart-area"></i>TEAM SHIMANO S.E.A. QUOTATION STATUS - <b>All Requests </b>
                            </div>
                        </div>
                        <div class="card-body">
        ...
        <div id="DvHdnField" runat="server" style="display: none">
            <asp:UpdatePanel runat="server" ID="UpdatePanel3" autopostback="false">
                <ContentTemplate>
                    <asp:TextBox runat="server" ID="TxtPlant" value=""></asp:TextBox>
                    <asp:TextBox runat="server" ID="TxtVendorCode" value=""></asp:TextBox>
