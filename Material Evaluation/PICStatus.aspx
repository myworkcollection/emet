<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PICStatus.aspx.cs" Inherits="Material_Evaluation.PICStatus" %>
                        ...
                        <div class="card-body" style="width: 100%; overflow: auto">
                            <div class="row" style="padding-bottom:10px;">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <asp:Label ID="lblRequest_view" runat="server" Font-Bold="true" Text="PIC APPROVAL "></asp:Label>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="table table-responsive table-sm">
                                        <asp:UpdatePanel ID="UpdatePanel1"  runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional"  RenderMode="Block">
                                            <ContentTemplate>
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound" CssClass="table-sm table-bordered">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="VendorName" >
                                                            <ItemTemplate>
                                                                <asp:LinkButton Text='<%# Eval("VendorName") %>' ItemStyle-Width="150px" runat="server" CommandName="LinktoRedirect" CommandArgument="<%# Container.DataItemIndex %>" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                          <asp:BoundField DataField="QuoteNo" HeaderText="QuoteNo" ItemStyle-Width="150px" >
                                                        <ItemStyle Width="150px" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:TemplateField HeaderText="PIC Approval" >
                                                            <ItemTemplate>
                                                                <asp:Button Text="Approve" runat="server" CssClass="AppRejClass"  CommandName="Approve" CommandArgument="<%# Container.DataItemIndex %>" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Reason" ItemStyle-Width="150">
                                                            <ItemTemplate>
                                                                <asp:TextBox AutoCompleteType="None" autocomplete="off" CssClass="dummyClass"  ID="txtReason" ClientIDMode="Static" runat="server" Text='<%# Eval("Reason") %>' />
