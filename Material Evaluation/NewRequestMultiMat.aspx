<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewRequestMultiMat.aspx.cs" Inherits="Material_Evaluation.NewRequestMultiMat" %>
...
<head>
    ...
    <link href="js/SELECT2/select2/css/select2.min.css" rel="stylesheet" />
    <link href="js/SELECT2/select2-bootstrap4-theme/select2-bootstrap4.min.css" rel="stylesheet" />
    <style type="text/css">
        .SideBarMenu {
            width: 300px;
        }
    ...
    <script type="text/javascript" src="js/SELECT2/select2/js/select2.full.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function initdropdownMatList2() {
            $('#DdlMatCodeList2').select2({
                minimumInputLength: 6,
                placeholder: '-- Enter SAP Mat Code Or Desc--',
                delay: 6000000000
            }).on('select2:select', function (evt) {
                ShowLoading();
                var data = $("#DdlMatCodeList2").select2('data')[0];
                $("#txtpartdesc").val(data.id);
            }).on('select2:clearing', function (evt) {
            });;
        }
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <asp:ListBox ID="DdlMatCodeList2" runat="server" SelectionMode="Multiple" onchange="EmptyRequestList();"></asp:ListBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
